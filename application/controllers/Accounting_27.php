...
class Accounting extends CI_Controller
{
    ...
    public function checkstatus_receipt($status='', $property_id='', $contact_id=''){
        ...
        if(count($result)>0) {
            ...
            { 
                if($bankentry[$i]['particulars']=='Rent' || $bankentry[$i]['particulars']=='Sale' || $bankentry[$i]['particulars']=='Income' || $bankentry[$i]['table_type']=='receipt') {
            ...
            { 
               if($pendingbankentry[$i]['particulars']=='Rent' || $pendingbankentry[$i]['particulars']=='Sale' || $pendingbankentry[$i]['particulars']=='Income' || $pendingbankentry[$i]['table_type']=='receipt')
                {
    ...
    public function checkstatus_payment($status='', $property_id='', $contact_id=''){
        ...
        if(count($result)>0) {
            ...
            for ($i=0; $i < count($bankentry) ; $i++) 
            { 
               if($bankentry[$i]['particulars']=='Purchase' || $bankentry[$i]['particulars']=='Loan' || $bankentry[$i]['particulars']=='Expense' || $bankentry[$i]['particulars']=='Maintenance' || $bankentry[$i]['table_type']=='payment') {
            ...
            for ($i=0; $i < count($pendingbankentry) ; $i++) 
            { 
               if($pendingbankentry[$i]['particulars']=='Purchase' || $pendingbankentry[$i]['particulars']=='Loan' || $pendingbankentry[$i]['particulars']=='Expense' || $pendingbankentry[$i]['particulars']=='Maintenance' || $pendingbankentry[$i]['table_type']=='payment') 
                {
                    $duedate =  ($pendingbankentry[$i]['due_date']!=null && $pendingbankentry[$i]['due_date']!='')?date('Y-m-d 00:00:00',strtotime($pendingbankentry[$i]['due_date'])):''; 
