            ...
            <!-- PAGE CONTENT -->
             <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                ...
                <?php $this->load->view('templates/menus');?>
                  <div class="heading-h2"><a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; <a href="<?php echo base_url().'index.php/owners'; ?>" > Owner List</a>  &nbsp; &#10095; &nbsp;    Trust View</div>
                  <div class="pull-right btn-top-margin responsive-margin">
					 <a class="printdiv btn-margin"> <span class="btn btn-warning pull-right btn-font"> Print </span>  </a> 
					  <?php  if(isset($access)) { if($access[0]->r_edit == 1) {  ?><a class="btn-margin" href="<?php echo base_url().'index.php/Owners/edit_trust/'.$o_id; ?>"> 
					         ...
					         <div class="col-md-12" style="padding:0;">	
					           <div class="full-width" >
					           	 <div class="panel panel-default">
											...
											<div class="panel-body individual-heading" >
														...
														<div class="form-group" style="border-top:0px dotted #ddd;">
															<div class="col-md-6 col-sm-6 col-xs-12">
																<div class="">
																	<label class="col-md-3 col-sm-5 col-xs-12 position-name  control-label" ><strong>Trust  Name:</strong></label>
																	<div class="col-md-9 col-sm-7 col-xs-12 position-view ">
																	  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($trust_detail)) { echo $trust_detail[0]->ow_trs_comapny_name; } ?></label>
																	</div>
																</div>
															</div>
															<div class="col-md-6 col-sm-6 col-xs-12">
																<div class="">
																	...
																	<div class="col-md-9 col-sm-7 col-xs-12 position-view ">
																		<label class="col-md-12 control-label contact-view" style="text-align:left;"> <?php if(isset($trust_detail)) { echo  $trust_detail[0]->ow_reg_no; } ?></label>
																	</div>
																</div>
															</div>
														</div>
														<div class="form-group">
															<div class="col-md-6 col-sm-6 col-xs-12">
																<div class="">
																  ...
																  <div class="col-md-9 col-sm-7 col-xs-12 position-view ">
																	  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($trust_detail)) { if($trust_detail[0]->ow_trs_incopdate!='' && $trust_detail[0]->ow_trs_incopdate!=null) echo date('d/m/Y', strtotime($trust_detail[0]->ow_trs_incopdate)); } ?></label>
																	</div>
																</div>
															</div>
															<div class="col-md-6 col-sm-6 col-xs-12">
																<div class="">
																  ...
																  <div class="col-md-9 col-sm-7 col-xs-12 position-view ">
																	  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if (set_value('contact_person_name')!=null) { echo set_value('contact_person_name'); } else if(isset($trust_detail[0]->c_name)){ echo $trust_detail[0]->c_name; } else { echo ''; }?></label>
																	</div>
																</div>
															</div>
														</div>
															...
															<div class="col-md-6 col-sm-6 col-xs-12">
																<div class="">
																	...
																	<div class="col-md-9 col-sm-7 col-xs-12 position-address">
																	  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($trust_detail)) { echo get_address($trust_detail[0]->ow_trs_address, $trust_detail[0]->ow_trs_landmark, $trust_detail[0]->ow_trs_city, $trust_detail[0]->ow_trs_pincode, $trust_detail[0]->ow_trs_state, $trust_detail[0]->ow_trs_country); } ?></label>
																	</div>
																</div>
															</div>
															<div class="col-md-6 col-sm-6 col-xs-12">
																<div class="">
																	...
																	<div class="col-md-9 col-sm-7 col-xs-12 position-address">
																	  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($trust_detail)) { echo $trust_detail[0]->ow_trs_branch; } ?></label>
																	</div>
																</div>
															</div>
														...
														<div class="form-group print-border">
															<div class="col-md-6 col-sm-6 col-xs-12">
																<div class="">
																  ...
																  <div class="col-md-9 col-sm-7 col-xs-12 position-view ">
																	  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($trust_detail)) { echo $trust_detail[0]->ow_trs_tel; } ?></label>
																	</div>
																</div>
															</div>
															<div class="col-md-6 col-sm-6 col-xs-12">
																<div class="">
																  ...
																  <div class="col-md-9 col-sm-7 col-xs-12 position-view ">
																	  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($trust_detail)) { echo $trust_detail[0]->ow_trs_mob; } ?></label>
																	</div>
																</div>
															</div>
														</div>
											 ...
											 <div class="panel-heading"  >
												<h3 class="panel-title"  ><strong>Trustee Details</strong></h3>
										  </div>
												...
												<div class="row">
													...
													<table id="contacts" class="table table-bordered" style="margin: 0px;">
														...
														?>
															<tr>
															  <td class="Contact_name"><?php if(isset($trust_trustee[$dir_cnt]->c_name)){ echo $trust_trustee[$dir_cnt]->c_name; } else { echo ''; }?></td>
											 ...
											 <div class="panel-heading" style="margin-top:10px;  ">
												...
												<div class="row">
													...
													<table id="contacts" class="table table-bordered" style="margin: 0px;">
														<thead>
															<tr>
															  <th width="75%">Beneficiary  Name</th>
														...
														?>
															<tr>
															  <td class="Contact_name"><?php if(isset($trust_beneficiary[$shr_hld_cnt]->c_name)){ echo $trust_beneficiary[$shr_hld_cnt]->c_name; } else { echo ''; }?></td>
																<td class="Contact_name"><?php echo $trust_beneficiary[$j]->trst_percent; ?></td>
															</tr>
														<?php $shr_hld_cnt++; } } ?>	
														</tbody>
													</table>
											 ...
											 <div class="panel-heading" style=" margin-top:10px;  ">
												...
												<div class="row">
													...
													<table id="contacts" class="table table-bordered print-authorised" style="margin: 0px;">
														...
														?>
															<tr>
															  <td class="Contact_name"><?php if(isset($trust_ath[$aut_sig_cnt]->c_name)){ echo $trust_ath[$aut_sig_cnt]->c_name; } else { echo ''; }?></td>
																<td class="Contact_name"><?php echo $trust_ath[$j]->ath_purpose; ?></td>
															</tr>
														<?php $aut_sig_cnt++; } } ?>	
														</tbody>
													</table>
														...
														<div class="panel-body">
															<div class="form-group" style="border-top:0px dotted #ddd;">
																<div class="col-md-12 remark">
																	...
																	<div class="col-md-10 remark">
																		<label class="col-md-12 remark control-label contact-view" style="text-align:left;"><?php if(isset($trust_detail)) { echo $trust_detail[0]->ow_maker_remark; } ?></label>
																	</div>
																</div>
															</div>
															<div class="form-group print-border print-form-group">
																<div class="col-md-12 remark">
																	...
																	<div class="col-md-10 remark">
																		<label class="col-md-12 remark control-label contact-view" style="text-align:left;"><?php if(isset($trust_detail)) { echo $trust_detail[0]->ow_txnremarks; } ?></label>
																	</div>
																</div>
															</div>
														</div>
										...
										<?php if(isset($trust_detail)) { ?>
										<?php if($trust_detail[0]->ow_status == 'Approved') { if(isset($access)) { if($access[0]->r_delete == 1) { ?> 
										  
											<form id="" method="post" action="<?php echo base_url().'index.php/Owners/updatetrust/'.$o_id; ?>">
												<div class="panel-body" style="margin-top:10px;">
													<div class="row">
													  <div class="col-md-2 address-remark sr" id=""> <label >Remarks</label> </div> 
														<div class="col-md-10 address-container1">
															<textarea type="text" id="txtstatus" name="status_remarks" class="form-control" placeholder="Remarks" ><?php if(isset($trust_detail[0])){ echo $trust_detail[0]->ow_txnremarks; } else { echo ''; }?></textarea>
														</div>
										...
										<?php } } } else if($trust_detail[0]->ow_modified_by != '' && $trust_detail[0]->ow_modified_by != null) { if($trust_detail[0]->ow_modified_by!=$ownerby) { if($trust_detail[0]->ow_status != 'In Process') { if(isset($access)) { if($access[0]->r_approvals == 1) { ?> 
										  
											<form id="" method="post" action="<?php echo base_url().'index.php/Owners/approvetrust/'.$o_id; ?>">
												<div class="panel-body" style="margin-top:10px;">
													<div class="row">
													  <div class="col-md-2 address-remark sr" id=""> <label >Remarks</label> </div> 
														<div class="col-md-10 address-container1">
										...
										<?php } } else if($trust_detail[0]->ow_create_by != '' && $trust_detail[0]->ow_create_by != null) { if($trust_detail[0]->ow_create_by!=$ownerby && $trust_detail[0]->ow_status != 'In Process') { if($trust_detail[0]->ow_status != 'In Process') { if(isset($access)) { if($access[0]->r_approvals == 1) { ?> 
