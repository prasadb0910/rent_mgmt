            ...
            <!-- PAGE CONTENT -->
             <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                ...
                <?php $this->load->view('templates/menus');?>
					 <div class="heading-h2"><a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; <a href="<?php echo base_url().'index.php/owners'; ?>" > Owner List</a>  &nbsp; &#10095; &nbsp; Owner Details -  AOP</div>
                     ...
                     <div class="row main-wrapper">
				    	<div class="main-container">           
                          <div class="box-shadow custom-padding"> 						
                            <div class="" id="llp">
                                <form id="form_aop" role="form" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php if(isset($llp_detail)) { echo base_url().'index.php/owners/updateaop/'.$o_id; }else { echo base_url().'index.php/owners/saveaop'; } ?>">
                                    ...
                                    <div class="panel-body box-padding">
                                        <div class="form-group"  style="border-top: 1px dotted #ddd;">
                                            <div class="col-md-6">                                                
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="organisation_name" placeholder="Organisation Name" value="<?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_aop_comapny_name; } ?>" />
                                                    </div>
												 </div>
												 <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6">                                             
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control datepicker1" name="date_of_incorporation" placeholder="Date of Incorporation" value="<?php if(isset($llp_detail)) { if($llp_detail[0]->ow_aop_incopdate!='' && $llp_detail[0]->ow_aop_incopdate!=null) echo date('d/m/Y', strtotime($llp_detail[0]->ow_aop_incopdate)); } ?>"/>
                                                    </div>
												 </div>
												 <div class="col-md-6">       
                                                    <label class="col-md-3 control-label">Contact Person <span class="asterisk_sign">*</span></label>
                                                    <div class="col-md-9">
                                                        <input type="hidden" id="contact_person_id" name="contact_person" class="form-control" value="<?php if (set_value('contact_person')!=null) { echo set_value('contact_person'); } else if(isset($llp_detail[0]->ow_aop_contact)){ echo $llp_detail[0]->ow_aop_contact; } else { echo ''; }?>" />
                                        ...
                                        <div class="form-group">
                                               <div class="col-md-6">                                                
                                                    ...
                                                    <div class="col-md-9">
                                                            <input type="text" class="form-control" name="registered_address" placeholder="Address" value="<?php if(isset($llp_detail)) { echo  $llp_detail[0]->ow_aop_address; } ?>"/>
                                                    </div>
													  </div>
												    <div class="col-md-6">
                                                    <label class="col-md-3 control-label">Landmark</label>
                                                    <div class="col-md-9">
                                                            <input type="text" class="form-control" name="aop_addr_landmark" placeholder="Landmark" value="<?php if(isset($llp_detail)) { echo  $llp_detail[0]->ow_aop_landmark; } ?>"/>
                                                    </div>
                                                </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-6">                                              
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="hidden" name="aop_addr_city_id" id="aop_addr_city_id" />
                                                        <input type="text" class="form-control autocompleteCity" name="aop_addr_city" id ="aop_addr_city" placeholder="Address City" value="<?php if(isset($llp_detail)) { echo  $llp_detail[0]->ow_aop_city; } ?>"/>
                                                    </div>
											</div>
											    <div class="col-md-6">
                                                    <label class="col-md-3 control-label"> Pincode <span class="asterisk_sign">*</span></label>
                                                    <div class="col-md-9">
                                                            <input type="text" class="form-control" name="aop_addr_pincode" id="aop_addr_pincode" placeholder="Address Pincode" value="<?php if(isset($llp_detail)) { echo  $llp_detail[0]->ow_aop_pincode; } ?>"/>
                                                    </div>
                                                </div>                                           
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="hidden" name="aop_addr_state_id" id="aop_addr_state_id" />
                                                            <input type="text" class="form-control loadstatedropdown" name="aop_addr_state" id="aop_addr_state" placeholder="Address State" value="<?php if(isset($llp_detail)) { echo  $llp_detail[0]->ow_aop_state; } ?>"/>
                                                    </div>
												 </div>
												   <div class="col-md-6">
                                                    <label class="col-md-3 control-label">Country</label>
                                                    <div class="col-md-9">
                                                        <input type="hidden" name="aop_addr_country_id" id="aop_addr_country_id">
                                                            <input type="text" class="form-control loadcountrydropdown" name="aop_addr_country" id="aop_addr_country" placeholder="Country" value="<?php if(isset($llp_detail)) { echo  $llp_detail[0]->ow_aop_country; } ?>"/>
                                                    </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="form-group">                                            
                                            <div class="col-md-6">                                                
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="branch_address" placeholder="Branch Address" value="<?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_aop_branch; } ?>"/>
                                                    </div>
												</div>
												 <div class="col-md-6">
                                                    <label class="col-md-3 control-label">Telephone No</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="telephone_number" placeholder="Telephone Number" value="<?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_aop_tel; } ?>"/>
                                                    </div>
                                                </div>   
                                        </div>
                                        <div class="form-group">
                                            <div class="col-md-6">                                                
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="mob_number" placeholder="Mobile Number" value="<?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_aop_mob; } ?>"/>
                                                    </div>
                                    ...
                                    <div class="llppartner">
                                        ...
                                        <div class="form-group" id="llp_partner_<?php echo ($dir_cnt+1); ?>" style="<?php if($dir_cnt==0) echo 'border-top: 1px dotted #ddd;'; else echo ''; ?>">
                                            <div class="col-md-6">
                                                <div class="col-md-3">
                                                    <label class="col-md-12 control-label">Partner <?php echo ($dir_cnt+1); ?> <span class="asterisk_sign">*</span></label>

                                                </div>
                                                <div class="col-md-9">
                                                    <input type="hidden" id="partner_details_<?php echo $dir_cnt+1 . '_id'; ?>" name="partner_name[]" class="form-control" value="<?php if(isset($llp_partner[$dir_cnt]->aop_partnerid)){ echo $llp_partner[$dir_cnt]->aop_partnerid; } else { echo ''; }?>" />
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="partner_percent_<?php echo ($dir_cnt+1); ?>" name="partner_percent[]" placeholder="Partnership %" value="<?php echo $llp_partner[$dir_cnt]->aop_percent; ?>" style="width:90%; float:left;"/>
                                    ...
                                    <div class="">
                                        <div class="col-md-12">
                                            <div class="">
                                                ...
                                                <div class="col-md-12 btn-margin" style="border:none;">                                                        
                                    ...
                                    <div class="panel-body box-padding">
                                        <div class="llpsign">
                                            ...
                                            <div class="form-group" id="llp_sign_<?php echo $aut_sig_cnt+1; ?>" style="<?php if($aut_sig_cnt==0) echo 'border-top: 1px dotted #ddd;'; else echo ''; ?>">
                                            <div class="col-md-6">
                                                <div class="col-md-4">
                                                    <label class="col-md-12 control-label">Authorised Signatory <?php echo ($aut_sig_cnt+1); ?></label>

                                                </div>
                                                <div class="col-md-8">
                                                    <input type="hidden" id="auth_details_<?php echo $aut_sig_cnt+1 . '_id'; ?>" name="auth_name[]" class="form-control" value="<?php if(isset($llp_auth[$aut_sig_cnt]->aop_contactid)){ echo $llp_auth[$aut_sig_cnt]->aop_contactid; } else { echo ''; }?>" />
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" name="auth_purpose[]" placeholder="Purpose of AS" value="<?php echo $llp_auth[$aut_sig_cnt]->aop_purpose; ?>" />
                                                </div>
                                            </div>
