            ...
            <!-- PAGE CONTENT -->
             <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                ...
                <?php $this->load->view('templates/menus');?>
				 <div class="heading-h2"><a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; <a href="<?php echo base_url().'index.php/owners'; ?>" > Owner List</a>  &nbsp; &#10095; &nbsp; Owner Details -  Partnership</div>
                     ...
                     <div class="row main-wrapper">
				    	<div class="main-container">           
                          <div class="box-shadow custom-padding"> 
                            ...
                            <div class="" id="llp">
                                <form id="form_llp" role="form" class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php if(isset($llp_detail)) { echo base_url().'index.php/owners/updatepartnership/'.$o_id; }else { echo base_url().'index.php/owners/savepartnership'; } ?>">
                                    ...
                                    <div class="panel-body box-padding">
                                        <div class="form-group" style="border-top: 1px dotted #ddd;">
                                            <div class="col-md-6">                                               
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="organisation_name" placeholder="Organisation Name" value="<?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_prt_comapny_name; } ?>" />
                                                    </div>
												</div>
											  <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control datepicker1" name="date_of_incorporation" placeholder="Date of Incorporation" value="<?php if(isset($llp_detail)) { if($llp_detail[0]->ow_prt_incopdate!='' && $llp_detail[0]->ow_prt_incopdate!=null) echo date('d/m/Y', strtotime($llp_detail[0]->ow_prt_incopdate)); } ?>"/>
                                                    </div>
												 </div>
												     <div class="col-md-6">
                                                    <label class="col-md-3 control-label">Contact Person <span class="asterisk_sign">*</span></label>
                                                    <div class="col-md-9">
                                                        <input type="hidden" id="contact_person_id" name="contact_person" class="form-control" value="<?php if (set_value('contact_person')!=null) { echo set_value('contact_person'); } else if(isset($llp_detail[0]->ow_prt_contact)){ echo $llp_detail[0]->ow_prt_contact; } else { echo ''; }?>" />
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="registered_address" placeholder="Address" value="<?php if(isset($llp_detail)) { echo  $llp_detail[0]->ow_prt_address; } ?>"/>
                                                    </div>
												</div>
											   <div class="col-md-6">
                                                    <label class="col-md-3 control-label">Landmark</label>
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="prt_addr_landmark" placeholder="Landmark" value="<?php if(isset($llp_detail)) { echo  $llp_detail[0]->ow_prt_landmark; } ?>"/>
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="hidden" name="prt_addr_city_id" id="prt_addr_city_id" />
                                                        <input type="text" class="form-control autocompleteCity" name="prt_addr_city" id ="prt_addr_city" placeholder="Address City" value="<?php if(isset($llp_detail)) { echo  $llp_detail[0]->ow_prt_city; } ?>"/>
                                                    </div>
											</div>
												  <div class="col-md-6">
                                                    <label class="col-md-3 control-label"> Pincode <span class="asterisk_sign">*</span></label>
                                                    <div class="col-md-9">
                                                            <input type="text" class="form-control" name="prt_addr_pincode" id="prt_addr_pincode" placeholder="Address Pincode" value="<?php if(isset($llp_detail)) { echo  $llp_detail[0]->ow_prt_pincode; } ?>"/>
                                                    </div>
                                        ...
                                        <div class="form-group">                                         
                                             <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="hidden" name="prt_addr_state_id" id="prt_addr_state_id" />
                                                            <input type="text" class="form-control loadstatedropdown" name="prt_addr_state" id="prt_addr_state" placeholder="Address State" value="<?php if(isset($llp_detail)) { echo  $llp_detail[0]->ow_prt_state; } ?>"/>
                                                    </div>
												 </div>
												    <div class="col-md-6">
                                                    <label class="col-md-3 control-label">Country</label>
                                                    <div class="col-md-9">
                                                        <input type="hidden" name="prt_addr_country_id" id="prt_addr_country_id">
                                                            <input type="text" class="form-control loadcountrydropdown" name="prt_addr_country" id="prt_addr_country" placeholder="Country" value="<?php if(isset($llp_detail)) { echo  $llp_detail[0]->ow_prt_country; } ?>"/>
                                                    </div>
                                                 </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6">                                                
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="branch_address" placeholder="Branch Address" value="<?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_prt_branch; } ?>"/>
                                                    </div>
												 </div>
											   <div class="col-md-6">
                                                    <label class="col-md-3 control-label">Telephone No</label>
                                                    <div class="col-md-9">
                                                        <input  type="text" class="form-control" name="telephone_number" placeholder="Telephone Number" value="<?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_prt_tel; } ?>"/>
                                                    </div>
                                                </div>                                                                                    
                                        </div>
                                        <div class="form-group">                                            
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" class="form-control" name="mob_number" placeholder="Mobile Number" value="<?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_prt_mob; } ?>"/>
                                                    </div>                                                  
                                                </div>                                             
                                        </div>
                                        ...
                                        <div class="llppartner">
                                            ...
                                            <div class="form-group" id="llp_partner_<?php echo $dir_cnt+1; ?>" style="<?php if($j==0) echo 'border-top: 1px dotted #ddd;'; ?>">
                                            <div class="col-md-6">
                                                <div class="col-md-3" style="padding-right: 0px;">

                                                    <label class="col-md-12 control-label" style="margin:0; padding-left: 0;">Partner <?php echo ($j+1); ?> <span class="asterisk_sign">*</span></label>
                                                </div>
                                                <div class="col-md-9">
                                                    <input type="hidden" id="partner_details_<?php echo $dir_cnt+1 . '_id'; ?>" name="partner_name[]" class="form-control" value="<?php if(isset($llp_partner[$dir_cnt]->prt_partnerid)){ echo $llp_partner[$dir_cnt]->prt_partnerid; } else { echo ''; }?>" />
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" id="partner_percent_<?php echo ($dir_cnt+1); ?>" name="partner_percent[]" placeholder="Partnership %" value="<?php echo $llp_partner[$j]->prt_percent; ?>" style="width:90%; float:left;"/>

                                                </div>
                                            </div>
                                            <?php $dir_cnt++; } } else { ?>

                                            <div class="form-group" id="llp_partner_<?php echo $dir_cnt+1; ?>" style="border-top: 1px dotted #ddd;"> 
                                            <div class="col-md-6">
                                                <div class="col-md-3" style="padding-right: 0px;">

                                                    <label class="col-md-12 control-label" style="margin:0; padding-left: 0;">Partner 1 <span class="asterisk_sign">*</span></label>
                                                </div>
                                                <div class="col-md-9">
                                        ...
                                        <div class="llpsign">
                                            ...
                                            <div class="form-group" id="llp_sign_<?php echo $aut_sig_cnt+1; ?>" style="<?php if($j==0) echo 'border-top: 1px dotted #ddd;'; ?>">
											   <div class="col-md-6" >
                                                <div class="col-md-3" >
                                                    <label class="col-md-12 control-label" style="margin:0; padding-left: 0; padding-right:0 !important;">Authorised Signatory <?php echo ($j+1); ?></label>
                                                </div>
                                                <div class="col-md-9">
                                                    <input type="hidden" id="auth_details_<?php echo $aut_sig_cnt+1 . '_id'; ?>" name="auth_name[]" class="form-control" value="<?php if(isset($llp_auth[$aut_sig_cnt]->prt_contactid)){ echo $llp_auth[$aut_sig_cnt]->prt_contactid; } else { echo ''; }?>" />
...
<!--                                                    <select class="form-control" name="auth_name[]" placeholder="Name">
                                                        <option>Select</option>
                                                        <?php // for ($i=0; $i < count($contact) ; $i++) { 
//                                                                echo "<option value='".$contact[$i]->c_id."' ";
//                                                                if($llp_auth[$j]->prt_contactid==$contact[$i]->c_id) { echo 'selected'; }
//                                                                echo " >".$contact[$i]->c_name."</option>";
//                                                        }?>
                                                    </select>-->
                                                </div>
												</div>
                                                <div class="col-md-6">
                                                    <input  type="text" class="form-control" name="auth_purpose[]" placeholder="Purpose of AS" value="<?php echo $llp_auth[$j]->prt_purpose; ?>" />
                                                </div>
                                            </div>
                                            ...
                                            <?php $aut_sig_cnt++; }} else { ?>
                                             ...
                                             <div class="col-md-6">
                                                <div class="col-md-3" style="padding-right: 0;padding-left:0;">
                                                    <label class="col-md-12 control-label" style="margin:0; padding-left: 0; padding-right:0 !important;">Authorised Signatory 1</label>
