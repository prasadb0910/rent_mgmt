...
@media screen and (min-width: 250px) and (max-width:1020px) 
	{
.custom-padding .col-md-2 {  padding:0px!important;}
            ...
            <!-- PAGE CONTENT -->
             <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                ...
                <?php $this->load->view('templates/menus');?>
                  <div class="heading-h2"><a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; <a href="<?php echo base_url().'index.php/owners'; ?>" > Owner List</a>  &nbsp; &#10095; &nbsp;    AOP View</div>
                  <div class="pull-right btn-top-margin responsive-margin">
				   ...
				   <?php  if(isset($access)) { if($access[0]->r_edit == 1) {  ?> <a class="btn-margin" href="<?php echo base_url().'index.php/Owners/edit_aop/'.$o_id; ?>"> 
					        	...
					        	<div class="panel panel-default">
								   <form id="jvalidate" role="form" class="form-horizontal" action="javascript:alert('Form #validate2 submited');">
											...
											<div class="panel-body individual-heading"  >
												...
												<div class="form-group" style="border-top:0px dotted #ddd;">
													<div class="col-md-6 col-sm-6 col-xs-12">
														<div class="">
															<label class="col-md-3 col-sm-5 col-xs-12 control-label"  ><strong>Organisation Name:</strong></label>
															  <div class="col-md-9 col-sm-7 col-xs-12">
															  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_aop_comapny_name; } ?></label>
															</div>
														</div>
													</div>
													<div class="col-md-6 col-sm-6 col-xs-12">
														<div class="">
															<label class="col-md-3 col-sm-5 col-xs-12 control-label"><strong>Registration No:</strong></label>
															  <div class="col-md-9 col-sm-7 col-xs-12">
												...
												<div class="form-group">
													<div class="col-md-6 col-sm-6 col-xs-12">
														<div class="">
														  <label class="col-md-3 col-sm-5 col-xs-12 control-label"><strong>Date of Incorp:</strong></label>
														    <div class="col-md-9 col-sm-7 col-xs-12">
															  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($llp_detail)) { if($llp_detail[0]->ow_aop_incopdate!='' && $llp_detail[0]->ow_aop_incopdate!=null) echo date('d/m/Y', strtotime($llp_detail[0]->ow_aop_incopdate)); } ?></label>
															</div>
														</div>
													</div>
													<div class="col-md-6 col-sm-6 col-xs-12">
														<div class="">
														  <label class="col-md-3 col-sm-5 col-xs-12 control-label"><strong>Contact Person:</strong></label>
														    <div class="col-md-9 col-sm-7 col-xs-12">
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<div class="">
															...
															<div class="col-md-9 col-sm-7 col-xs-12 position-address">
															 <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($llp_detail)) { echo get_address($llp_detail[0]->ow_aop_address, $llp_detail[0]->ow_aop_landmark, $llp_detail[0]->ow_aop_city, $llp_detail[0]->ow_aop_pincode, $llp_detail[0]->ow_aop_state, $llp_detail[0]->ow_aop_country); } ?></label>
															</div>
														</div>
													</div>
													<div class="col-md-6 col-sm-6 col-xs-12">
														<div class="">
															...
															<div class="col-md-9 col-sm-7 col-xs-12 position-branch">
															  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_aop_branch; } ?></label>
															</div>
														</div>
													</div>
													...
													<div class="col-md-6 col-sm-6 col-xs-12">
														<div class="">
														  <label class="col-md-3 col-sm-5 col-xs-12 control-label" ><strong>Telephone No.:</strong></label>
														    <div class="col-md-9 col-sm-7 col-xs-12">
															  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_aop_tel; } ?></label>
															</div>
														</div>
													</div>
													<div class="col-md-6 col-sm-6 col-xs-12">
														<div class="">
														  <label class="col-md-3 col-sm-5 col-xs-12 control-label" ><strong>Mobile No.:</strong></label>
														  <div class="col-md-9 col-sm-7 col-xs-12">
															  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_aop_mob; } ?></label>
															</div>
														</div>
													</div>
												</div> 
                                   	...
                                   	<div class="form-group print-border">
										<div class="col-md-6 col-sm-6 col-xs-12">
											<div class="">
												<label class="col-md-3 col-sm-5 col-xs-12 position-name control-label" style="padding-left:0;"><strong> Registered Add.: </strong></label>
												<div class="col-md-9 col-sm-7 col-xs-12 position-address">
												  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($llp_detail)) { echo get_address($llp_detail[0]->ow_aop_address, $llp_detail[0]->ow_aop_landmark, $llp_detail[0]->ow_aop_city, $llp_detail[0]->ow_aop_pincode, $llp_detail[0]->ow_aop_state, $llp_detail[0]->ow_aop_country); } ?></label>
												</div>
													...
													<table id="contacts" class="table table-bordered" style="margin: 0px;">
														...
														?>
															<tr>
																...
																<td class="Contact_name"><?php echo $llp_partner[$j]->aop_percent; ?></td>
															</tr>
														<?php $dir_cnt++; } } ?>	
														</tbody>
													</table>
														...
														<?php $aut_sig_cnt=0; if(isset($llp_auth)) { 
															...
															<tr>
															  <td class="Contact_name"><?php if(isset($llp_auth[$aut_sig_cnt]->c_name)){ echo $llp_auth[$aut_sig_cnt]->c_name; } else { echo ''; }?></td>
																<td class="Contact_name"><?php echo $llp_auth[$j]->aop_purpose; ?></td>
															</tr>
														<?php $aut_sig_cnt++; } } ?>	
														</tbody>
													</table>
											...
											<div class="panel-body">
												<div class="form-group col-md-12 remark print-form-group" style="border-top:0px dotted #ddd;">
													<label class="col-md-2 remark control-label"  ><strong>Maker Remark:</strong></label>
													<div class="col-md-10">
														<label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_maker_remark; } ?></label>
													</div>
												</div>
												<div class="form-group col-md-12 remark print-form-group print-border">
													<label class="col-md-2 remark control-label" ><strong>Checker Remark:</strong></label>
													<div class="col-md-10">
														<label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_txnremarks; } ?></label>
													</div>
												</div>
											</div>
										...
										<?php if($llp_detail[0]->ow_status == 'Approved') { if(isset($access)) { if($access[0]->r_delete == 1) { ?> 
											...
											<form id="" method="post" action="<?php echo base_url().'index.php/Owners/updateaop/'.$o_id; ?>">
										...
										<?php } } } else if($llp_detail[0]->ow_modified_by != '' && $llp_detail[0]->ow_modified_by != null) { if($llp_detail[0]->ow_modified_by!=$ownerby) { if($llp_detail[0]->ow_status != 'In Process') { if(isset($access)) { if($access[0]->r_approvals == 1) { ?> 
											...
											<form id="" method="post" action="<?php echo base_url().'index.php/Owners/approveaop/'.$o_id; ?>">
												   <div class="panel-body" style="margin-top:10px;">
													<div class="row">
														 <div class="col-md-2 address-remark  sr" id=""> <label >Remarks</label> </div> 
														<div class="col-md-10 address-container1">
