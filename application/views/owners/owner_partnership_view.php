        ...
        <div class="page-container page-navigation-top">            
            ...
            <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                ...
                <?php $this->load->view('templates/menus');?>
				  <div class="heading-h2"><a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; <a href="<?php echo base_url().'index.php/owners'; ?>" > Owner List</a>  &nbsp; &#10095; &nbsp;    Partnership View</div>
                  <div class="pull-right btn-top-margin responsive-margin">
				    ...
				    <?php  if(isset($access)) { if($access[0]->r_edit == 1) {  ?><a  class="btn-margin"  href="<?php echo base_url().'index.php/Owners/edit_partnership/'.$o_id; ?>"> <span class="btn btn-success pull-right btn-font"> Edit </span> </a><?php } }  ?>
					    ...
					    <div class="box-shadow">   
					       <div class="box-shadow-inside custom-padding">	
                            ...
                            <form id="jvalidate" role="form" class="form-horizontal" action="javascript:alert('Form #validate2 submited');">
                                ...
                                <div class="panel-body individual-heading" >
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<div class="">
														...
														<div class="col-md-9 col-sm-7 col-xs-12">
														  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_prt_comapny_name; } ?></label>
														</div>
													</div>
												</div>
		                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
												<div class="col-md-6 col-sm-6 col-xs-12">
													<div class="">
													  ...
													  <div class="col-md-9 col-sm-7 col-xs-12">
														  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($llp_detail)) { if($llp_detail[0]->ow_prt_incopdate!='' && $llp_detail[0]->ow_prt_incopdate!=null) echo date('d/m/Y', strtotime($llp_detail[0]->ow_prt_incopdate)); } ?></label>
														</div>
													</div>
												</div>
												<div class="col-md-6 col-sm-6 col-xs-12">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<div class="">
														...
														<div class="col-md-9 col-sm-7 col-xs-12 position-address">
														  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($llp_detail)) { echo get_address($llp_detail[0]->ow_prt_address, $llp_detail[0]->ow_prt_landmark, $llp_detail[0]->ow_prt_city, $llp_detail[0]->ow_prt_pincode, $llp_detail[0]->ow_prt_state, $llp_detail[0]->ow_prt_country); } ?></label>
														</div>
													</div>
												</div>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
													<div class="">
														...
														<div class="col-md-9 col-sm-7 col-xs-12 position-branch">
														  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_prt_branch; } ?></label>
														</div>
													</div>
												</div>
                                           ...
                                           <div class="form-group print-border">
												<div class="col-md-6 col-sm-6 col-xs-12">
													<div class="">
													  ...
													  <div class="col-md-9 col-sm-7 col-xs-12">
														  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_prt_tel; } ?></label>
														</div>
													</div>
												</div>
												<div class="col-md-6 col-sm-6 col-xs-12">
													<div class="">
													  ...
													  <div class="col-md-9 col-sm-7 col-xs-12">
														  <label class="col-md-12 control-label lbl-mbl contact-view" style="text-align:left; "><?php if(isset($llp_detail)) { echo $llp_detail[0]->ow_prt_mob; } ?></label>
														</div>
													</div>
												</div>
											</div>
                                 ...
                                 <div class="panel-heading" >
                                            ...
                                            ?>
												<tr>
												  <td class="Contact_name"><?php if(isset($llp_partner[$dir_cnt]->c_name)){ echo $llp_partner[$dir_cnt]->c_name; } else { echo ''; }?></td>
													<td class="Contact_name"><?php echo $llp_partner[$j]->prt_percent; ?></td>
												</tr>
											<?php $dir_cnt++; } } ?>	
											</tbody>
										</table>
									...
									<h3 class="panel-title" style="padding:0px; "><strong>Documents Details</strong></h3>
							  </div>
								<div class="panel-body">
									<div class="row">
											...
											<thead>
												<tr>
												  <th width="19%">Document Name</th>
													...
													<th width="14%" class="th">Document</th>
												</tr>
											</thead>
											<tbody>
											...
											<?php $aut_sig_cnt=0; if(isset($llp_auth)) { 
												...
												<tr>
												  <td class="Contact_name"><?php if(isset($llp_auth[$aut_sig_cnt]->c_name)){ echo $llp_auth[$aut_sig_cnt]->c_name; } else { echo ''; }?></td>
													<td class="Contact_name"><?php echo $llp_auth[$j]->prt_purpose; ?></td>
												</tr>
											<?php $aut_sig_cnt++; } } ?>	
											</tbody>
										</table>
                            ...
                            <?php if($llp_detail[0]->ow_status == 'Approved') { if(isset($access)) { if($access[0]->r_delete == 1) { ?> 
                                ...
                                <form id="" method="post" action="<?php echo base_url().'index.php/Owners/updatepartnership/'.$o_id; ?>">
                                    <div class="panel-body" style="margin-top:10px;">
	                                    <div class="row">
	                                        ...
	                                        <div class="col-md-2 pull-right sr" id=""> <label >Remarks</label> </div>  
	                                    </div>
                                    </div>
                            ...
                            <?php } } } else if($llp_detail[0]->ow_modified_by != '' && $llp_detail[0]->ow_modified_by != null) { if($llp_detail[0]->ow_modified_by!=$ownerby) { if($llp_detail[0]->ow_status != 'In Process') { if(isset($access)) { if($access[0]->r_approvals == 1) { ?> 
                                ...
                                <form id="" method="post" action="<?php echo base_url().'index.php/Owners/approvepartner/'.$o_id; ?>">
                                    <div class="panel-body" style="margin-top:10px;">
	                                    <div class="row">
