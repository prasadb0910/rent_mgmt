            ...
            <!-- PAGE CONTENT -->
             <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">                  
                <?php $this->load->view('templates/menus');?>
                  <div class="heading-h2"><a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; <a href="<?php echo base_url().'index.php/owners'; ?>" > Owner List</a>  &nbsp; &#10095; &nbsp;    Proprietorship View</div>
                  <div class="pull-right btn-top-margin responsive-margin">
				   ...
				   <?php  if(isset($access)) { if($access[0]->r_edit == 1){  ?> <a class="btn-margin" href="<?php echo base_url().'index.php/Owners/edit_proprietorship/'.$o_id; ?>" > 
					           ...
					           <div class="full-width" >
								<div class="panel panel-default">
																	...
																	<div class="col-md-6 col-sm-6 col-xs-12">
																		<div class="">
																			...
																			<div class="col-md-9 col-sm-7 col-xs-12">
																			  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($proprietorship_detail)) { echo $proprietorship_detail[0]->ow_proprietorship_comapny_name; } ?></label>
																			</div>
																		</div>
																	</div>
																	<div class="col-md-6 col-sm-6 col-xs-12">
																		<div class="">
																			...
																			<div class="col-md-9 col-sm-7 col-xs-12">
																				<label class="col-md-12 control-label contact-view" style="text-align:left;"> <?php if(isset($proprietorship_detail)) { echo  $proprietorship_detail[0]->ow_reg_no; } ?></label>
																			</div>
																		</div>
																	</div>
																</div>
																<div class="form-group">
																	<div class="col-md-6 col-sm-6 col-xs-12">
																		<div class="">
																		  ...
																		  <div class="col-md-9 col-sm-7 col-xs-12">
																			  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($proprietorship_detail)) { if($proprietorship_detail[0]->ow_proprietorship_incopdate!='' && $proprietorship_detail[0]->ow_proprietorship_incopdate!=null) echo date('d/m/Y', strtotime($proprietorship_detail[0]->ow_proprietorship_incopdate)); } ?></label>
																			</div>
																		</div>
																	</div>
																	<div class="col-md-6 col-sm-6 col-xs-12">
																		<div class="">
																		  ...
																		  <div class="col-md-9 col-sm-7 col-xs-12">
																			  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if (set_value('contact_person_name')!=null) { echo set_value('contact_person_name'); } else if(isset($proprietorship_detail[0]->c_name)){ echo $proprietorship_detail[0]->c_name; } else { echo ''; }?></label>
																			</div>
																		</div>
																	</div>
																</div>
																	...
																	<div class="col-md-6 col-sm-6 col-xs-12">
																		<div class="">
																			...
																			<div class="col-md-9 col-sm-7 col-xs-12 position-address">
																			 <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($proprietorship_detail)) { echo get_address($proprietorship_detail[0]->ow_proprietorship_address, $proprietorship_detail[0]->ow_proprietorship_landmark, $proprietorship_detail[0]->ow_proprietorship_city, $proprietorship_detail[0]->ow_proprietorship_pincode, $proprietorship_detail[0]->ow_proprietorship_state, $proprietorship_detail[0]->ow_proprietorship_country); } ?></label>
																			</div>
																		</div>
																	</div>
																	<div class="col-md-6 col-sm-6 col-xs-12">
																		<div class="">
																			...
																			<div class="col-md-9 col-sm-7 col-xs-12 position-address">
																			  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($proprietorship_detail)) { echo $proprietorship_detail[0]->ow_proprietorship_branch; } ?></label>
																			</div>
																		</div>
																	</div>
															   ...
															   <div class="form-group  print-border">
																	...
																	<div class="col-md-6 col-sm-6 col-xs-12">
																		<div class="">
																		  ...
																		  <div class="col-md-9 col-sm-7 col-xs-12">
																			  <label class="col-md-12 lbl-mbl control-label contact-view" style="text-align:left;"><?php if(isset($proprietorship_detail)) { echo $proprietorship_detail[0]->ow_proprietorship_tel; } ?></label>
																			</div>
																		</div>
																	</div>
																	<div class="col-md-6 col-sm-6 col-xs-12">
																		<div class="">
																		  ...
																		  <div class="col-md-9 col-sm-7 col-xs-12">
																			  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($proprietorship_detail)) { echo $proprietorship_detail[0]->ow_proprietorship_mob; } ?></label>
																			</div>
																		</div>
																	</div>
																</div> 
													 ...
													 <div class="panel-body">
														<div class="row">
															...
															<table id="contacts" class="table table-bordered" style="margin: 0px;">
																...
																?>
																	<tr>
																	  <td class="Contact_name"><?php if(isset($proprietorship_owner[$dir_cnt]->c_name)){ echo $proprietorship_owner[$dir_cnt]->c_name; } else { echo ''; }?></td>
																		<!-- <td class="Contact_name"><?php //echo $proprietorship_owner[$j]->proprietorship_percent; ?></td> -->
																	</tr>
																<?php $dir_cnt++; } } ?>	
																</tbody>
															</table>
															...
															<table id="contacts" class="table table-bordered print-authorised" style="margin: 0px;">
																...
																<?php $aut_sig_cnt=0; if(isset($proprietorship_auth)) { 
																	for($j=0; $j < count($proprietorship_auth); $j++ ) {
																		?>
																	<tr>
																	  <td class="Contact_name"><?php if(isset($proprietorship_auth[$aut_sig_cnt]->c_name)){ echo $proprietorship_auth[$aut_sig_cnt]->c_name; } else { echo ''; }?></td>
																		<td class="Contact_name"><?php echo $proprietorship_auth[$j]->proprietorship_purpose; ?></td>
																	</tr>
																<?php $aut_sig_cnt++; } } ?>	
																</tbody>
															</table>
                                        	   ...
                                        	   <div class="panel-heading" style="margin-top:10px;">
														...
														<div class="form-group" >
															<div class="col-md-12 remark">
																...
																<div class="col-md-10 remark">
																	<label class="col-md-12 remark control-label contact-view" style="text-align:left;"><?php if(isset($proprietorship_detail)) { echo $proprietorship_detail[0]->ow_maker_remark; } ?></label>
																</div>
															</div>
														</div>
														<div class="form-group print-border print-form-group">
															<div class="col-md-12 remark">
																<label class="col-md-2 remark control-label"  ><strong>Checker Remark:</strong></label>
																<div class="col-md-10 remark">
																	<label class="col-md-12 remark control-label contact-view" style="text-align:left;"><?php if(isset($proprietorship_detail)) { echo $proprietorship_detail[0]->ow_txnremarks; } ?></label>
																</div>
															</div>
														</div>
													</div>
												...
												<?php if(isset($proprietorship_detail)) { ?>
												<?php if($proprietorship_detail[0]->ow_status == 'Approved') { if(isset($access)) { if($access[0]->r_delete == 1) { ?> 
												  
													<form id="" method="post" action="<?php echo base_url().'index.php/Owners/updateproprietorship/'.$o_id; ?>">
													 <div class="panel-body" style="margin-top:10px;">
															<div class="row">
																<div class="col-md-2 address-remark sr" id=""> <label >Remarks</label> </div>
																<div class="col-md-10  address-container1">
																	<textarea type="text" id="txtstatus" name="status_remarks" class="form-control" placeholder="Remarks" ><?php if(isset($proprietorship_detail[0])){ echo $proprietorship_detail[0]->ow_txnremarks; } else { echo ''; }?></textarea>
																</div>																 
															</div>
														</div>
												...
												<?php } } } else if($proprietorship_detail[0]->ow_modified_by != '' && $proprietorship_detail[0]->ow_modified_by != null) { if($proprietorship_detail[0]->ow_modified_by!=$ownerby) { if($proprietorship_detail[0]->ow_status != 'In Process') { if(isset($access)) { if($access[0]->r_approvals == 1) { ?> 
												  
													<form id="" method="post" action="<?php echo base_url().'index.php/Owners/approveproprietorship/'.$o_id; ?>">
													 <div class="panel-body" style="margin-top:10px;">
															<div class="row">
																<div class="col-md-2 address-remark sr" id=""> <label >Remarks</label> </div>
																<div class="col-md-10  address-container1">
												...
												<?php } } else if($proprietorship_detail[0]->ow_create_by != '' && $proprietorship_detail[0]->ow_create_by != null) { if($proprietorship_detail[0]->ow_create_by!=$ownerby && $proprietorship_detail[0]->ow_status != 'In Process') { if($proprietorship_detail[0]->ow_status != 'In Process') { if(isset($access)) { if($access[0]->r_approvals == 1) { ?> 
