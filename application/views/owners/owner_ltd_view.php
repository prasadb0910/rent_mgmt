            ...
            <!-- PAGE CONTENT -->
             <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                ...
                <?php $this->load->view('templates/menus');?>
				   <div class="heading-h2"><a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; <a href="<?php echo base_url().'index.php/owners'; ?>" > Owner List</a>  &nbsp; &#10095; &nbsp;    Ltd View</div>
                  <div class="pull-right btn-top-margin responsive-margin">
				   ...
				   <?php  if(isset($access)) { if($access[0]->r_edit == 1) {  ?>  <a class="btn-margin" href="<?php echo base_url().'index.php/Owners/edit_ltd/'.$o_id; ?>" > 
					    ...
					    <div class="col-md-12" style="padding:0;">	
					     <div class="full-width" >							
                            ...
                            <div id="pdiv" >
												 ...
												 <div class="col-md-6 col-sm-6 col-xs-12">
													<div class="">
														...
														<div class="col-md-9 col-sm-7 col-xs-12 position-view-1 ">
														  <label class="col-md-12 control-label contact-view" style="text-align:left;"> <?php if(isset($pvt_details)) { echo $pvt_details[0]->ow_ltd_comapny_name; } ?></label>
														</div>
													</div>
												</div>
		                                         <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
												 <div class="col-md-6 col-sm-6 col-xs-12">
													<div class="">
													  ...
													  <div class="col-md-9 col-sm-7 col-xs-12 position-view-1 ">
														  <label class="col-md-12 control-label contact-view" style="text-align:left;"> <?php if(isset($pvt_details)) { if($pvt_details[0]->ow_ltd_incopdate!='' && $pvt_details[0]->ow_ltd_incopdate!=null) echo date('d/m/Y', strtotime($pvt_details[0]->ow_ltd_incopdate)); } ?></label>
														</div>
													</div>
												</div>
												 <div class="col-md-6 col-sm-6 col-xs-12">
												 ...
												 <div class="col-md-6 col-sm-6 col-xs-12">
													<div class="">
														...
														<div class="col-md-9 col-sm-7 col-xs-12 position-address">
														  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($pvt_details)) { echo get_address($pvt_details[0]->ow_ltd_address, $pvt_details[0]->ow_ltd_landmark, $pvt_details[0]->ow_ltd_city, $pvt_details[0]->ow_ltd_pincode, $pvt_details[0]->ow_ltd_state, $pvt_details[0]->ow_ltd_country); } ?></label>
														</div>
													</div>
												</div>
                                                 <div class="col-md-6 col-sm-6 col-xs-12">
													<div class="">
														...
														<div class="col-md-9 col-sm-7 col-xs-12 position-branch">
														  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($pvt_details)) { echo $pvt_details[0]->ow_ltd_branch; } ?></label>
														</div>
													</div>
												</div>
                                           	...
                                           	<div class="form-group print-border">
												 <div class="col-md-6 col-sm-6 col-xs-12">
													<div class="">
													  ...
													  <div class="col-md-9 col-sm-7 col-xs-12 position-view-1 ">
														  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($pvt_details)) { echo $pvt_details[0]->ow_ltd_tel; } ?></label>
														</div>
													</div>
												</div>
												 <div class="col-md-6 col-sm-6 col-xs-12">
													<div class="">
													  ...
													  <div class="col-md-9 col-sm-7 col-xs-12 position-view-1 ">
														  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($pvt_details)) { echo $pvt_details[0]->ow_ltd_mob; } ?></label>
														</div>
													</div>
												</div>
											</div>
								...
								<?php $dir_cnt=0; if(isset($pvt_direct)) { 
									...
									<div class="form-group print-border" style="clear:both;">
										 ...
										 <div class="col-md-6 col-sm-6 col-xs-12">
											<div class="">											
											  <label class=" col-md-3 col-sm-5 col-xs-12  control-label" ><strong>Director Name:</strong></label>
											  <div class="col-md-9 col-sm-7  col-xs-12">
												  <label class="col-md-12 control-label contact-view" style="text-align:left;"><?php if(isset($pvt_direct[$dir_cnt]->c_name)){ echo $pvt_direct[$dir_cnt]->c_name; } else { echo ''; }?></label>
												</div>
											</div>
										</div>
                              ...
                              <div class="panel-body">
									<div class="">
										...
										<table id="contacts" class="table table-bordered" style="margin: 0px; border:1px solid #ddd!important;">
											<thead>
												<tr>
												  <th width="75%">Shareholder  Name</th>
										...
										?>
												<tr>
												  <td class="Contact_name"><?php if(isset($pvt_share[$shr_hld_cnt]->c_name)){ echo $pvt_share[$shr_hld_cnt]->c_name; } else { echo ''; }?></td>
								...
								<div class="">
									...
									<div class="row">
										...
										<table id="contacts" class="table table-bordered print-authorised" style="margin: 0px;">
											...
											?>
												<tr>
												  <td class="Contact_name"><?php if(isset($pvt_signatory[$aut_sig_cnt]->c_name)){ echo $pvt_signatory[$aut_sig_cnt]->c_name; } else { echo ''; }?></td>
                            ...
                            <?php if($pvt_details[0]->ow_status == 'Approved') { if(isset($access)) { if($access[0]->r_delete == 1) { ?> 
                                ...
                                <form id="" method="post" action="<?php echo base_url().'index.php/Owners/updateltd/'.$o_id; ?>">
                            ...
                            <?php } } } else if($pvt_details[0]->ow_modified_by != '' && $pvt_details[0]->ow_modified_by != null) { if($pvt_details[0]->ow_modified_by!=$ownerby) { if($pvt_details[0]->ow_status != 'In Process') { if(isset($access)) { if($access[0]->r_approvals == 1) { ?> 
                                ...
                                <form id="" method="post" action="<?php echo base_url().'index.php/Owners/approveltd/'.$o_id; ?>">
                                        <div class="panel-body" style="margin-top:10px;">
	                                    <div class="row">
	                                           <div class="col-md-2 address-remark   sr" id=""> <label >Remarks</label> </div> 
	                                        <div class="col-md-10 address-container1">
