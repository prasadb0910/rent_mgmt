            ...
            <div id="rootwizard">
                <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist" data-init-reponsive-tabs="dropdownfx">
                    ...
                    <li class="nav-item inprocess">
                        <a class="<?php if($checkstatus=='InProcess') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/Loan_disbursement/checkstatus/InProcess">Draft(<?php echo $inprocess; ?>)</a>
                    </li>
                </ul>
                <br>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="all">
                                        <div id="myDIV">
                                            ...
                                            <a href="<?php echo base_url(); ?>index.php/Loan_disbursement/addnew/<?=$lid?>"><button class="btn btn-default pull-right" type="submit"><i class="fa fa-plus tab-icon"></i> <span>Add Loan Disbursement</span></button></a>
                                        </div>
                                        <br>
                                        <div class="row grid">
