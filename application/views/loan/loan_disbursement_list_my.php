    ...
    <div class="content ">
        <div class=" container-fluid container-fixed-lg">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Loan Disbursement List</a></li>
            </ol>

            <div id="rootwizard">
                <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist" data-init-reponsive-tabs="dropdownfx">
                    <li class="nav-item all">
                        <a class="<?php if($checkstatus=='All') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/Loan_disbursement/checkstatus/All">All(<?php echo $all; ?>)</a>
                    </li>
                    <li class="nav-item approved">
                        <a class="<?php if($checkstatus=='Approved') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/Loan_disbursement/checkstatus/Approved">Approved(<?php echo $approved; ?>)</a>
                    </li>
                    <li class="nav-item pending">
                        <a class="<?php if($checkstatus=='Pending') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/Loan_disbursement/checkstatus/Pending">Pending(<?php echo $pending; ?>)</a>
                    </li>
                    <li class="nav-item rejected">
                        <a class="<?php if($checkstatus=='Rejected') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/Loan_disbursement/checkstatus/Rejected">Rejected(<?php echo $rejected; ?>)</a>
                    </li>
                    <li class="nav-item inprocess">
                        <a class="<?php if($checkstatus=='InProcess') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/Loan_disbursement/checkstatus/InProcess">IN Process(<?php echo $inprocess; ?>)</a>
                    </li>
                </ul>
                <br>
                            ...
                            <div class="col-md-12">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="all">
                                        ...
                                        <div>
                                            <a href="<?php echo base_url(); ?>index.php/Loan_disbursement/addnew"><button class="btn btn-default pull-right" type="submit"><i class="fa fa-plus tab-icon"></i> <span>Add Property</span></button></a>
                                        </div>
                                        <br>
                                        <div class="row grid">
                                            ...
                                            <div class=" col-md-6">
                                                <div class="markup">
                                                    <div class="card card-transparent container-fixed-lg bg-white " style="background:#fff;">
                                                        <div class="row">
                                                            <div class=" col-md-4">
                                                                <img src="<?php echo base_url().$loan[$i]->image; ?>" alt="Paris" class="prop_img m-t-20 m-l-20" style="width:180px">
                                                            </div>
                                                            <div class=" col-md-8">
                                                                ...
                                                                <div class="card-block">
                                                                    <p class=" flat_info m-t-0 m-b-0"><?php echo $loan[$i]->p_type . ', ' . $loan[$i]->pr_agreement_area . ' ' . $loan[$i]->pr_agreement_area . ', ' . $loan[$i]->p_status; ?></p>
                                                        ...
                                                        <div class="row" style="padding-left:15px;padding-right:15px;">
                                                            <div class="col-md-2 rent">
                                                                <i style="font-size:22px;" class="fa fa-group"></i><br>
                                                                Tenants
                                                            </div>
                                                            <div class=" col-md-2 leases">
                                                                <i style="font-size:22px;" class="fa fa-inr "></i><br>
                                                                Accounting
                                                            </div>
                                                            <div class=" col-md-2 leases" style="border-left: 2px solid #edf0f5;">
                                                        ...
                                                        <div class="col-md-12">
                                                            <a href="<?php echo base_url().'index.php/Loan_disbursement/view/'.$loan[$i]->txn_id; ?>" class=" pull-right invoice p-b-5     p-t-5" style="color:#5cb85c;">View <i class="fa fa-angle-right tab-icon"></i> </a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class=" col-md-12">
                                                <div class="card card-transparent container-fixed-lg bg-white " style="background:#fff;">
                                                    <div class="row">
                                                        ...
                                                        <p class=" flat_info m-t-0 m-b-0 pull-left" style="margin-top: 45px;padding-left: 20px;"><?php echo $loan[$i]->p_type . ', ' . $loan[$i]->pr_agreement_area . ' ' . $loan[$i]->pr_agreement_area . ', ' . $loan[$i]->p_status; ?></p>
                                                        ...
                                                        <div class="prop_btns">
                                                            ...
                                                            <div class="pull-left" style="margin-top: 40px;padding-left: 20px;">
                                                                <a href="<?php echo base_url(); ?>index.php/Loan_disbursement_disbursement" data-toggle="tooltip" data-placement="bottom" title="Maintenance"><i style="font-size:22px;" class="fa fa-file-text-o"></i></a>
                                                            </div>
                                                        </div>
                                                        <a href="<?php echo base_url().'index.php/Loan_disbursement/view/'.$loan[$i]->txn_id; ?>" class=" pull-left invoice" style="color:#5cb85c;margin-top: 37px;padding-left: 30px;">View <i class="   fa fa-angle-right tab-icon"></i> </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php } ?>
