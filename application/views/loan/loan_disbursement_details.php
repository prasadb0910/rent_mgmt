...
<head>
    ...
    <style>
		...
		#loan_details .select2-container,#loan_disbursement .select2-container
		{
			   z-index:0!important;
		}
    </style>
...
<div class="content">
    ...
    <div class=" container-fluid   container-fixed-lg ">
        <ol class="breadcrumb">
            ...
            <?php if(isset($editloan)){ ?><li class="breadcrumb-item"><a href="<?php if (isset($l_id)) echo base_url().'index.php/Loan_disbursement/view/'.$l_id; ?>">Loan Disbursement View</a></li>
				  <?php } ?>
            ...
            <div class="col-md-8">
                <div class=" container-fluid container-fixed-lg bg-white">
                    <div class="card card-transparent">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select  class="form-control full-width" id="loan_ref_name" name="loan_id" data-placeholder="Select " data-init-plugin="select2" data-minimum-results-for-search="Infinity">
                                        <?php print_r($editloan);?>
                                        <?php print_r($editloan[0]->loan_ref_id);?>
                                            <?php if(isset($loan_txn)) { if(isset($editloan[0]->loan_ref_id)) { 
                                                for($i=0; $i<count($loan_txn); $i++) {
                                                 $selected=  ($loan_txn[$i]->ref_id==$editloan[0]->loan_ref_id?'selected':'');?>; 
                                                 ?>
                                                    <option value="<?php echo $loan_txn[$i]->txn_id; ?>" <?=$selected?>><?php echo $loan_txn[$i]->ref_id?></option>
                                            <?php } } else { ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        ...
                                        <input type="text" class="form-control " id="loan_ref_id"  placeholder="Enter Here" value="<?php if(isset($editloan)) { echo $editloan[0]->loan_ref_name;} ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Loan Type</label>
                                        <input type="text" class="form-control " id="loan_type"  placeholder="Enter Here" value="<?php if(isset($editloan)) { echo $editloan[0]->loan_type;} ?>" readonly >
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Amount</label>
                                        <input type="text" class="form-control " id="loan_amount" placeholder="Enter Here" value="<?php if(isset($editloan)) { echo format_money($editloan[0]->loan_amount,2);} ?>" readonly >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default  ">
                                        <label>Loan Start Date</label>
                                        <input id="start_date" type="text" class="form-control "  placeholder="Enter Here" name="loan_start_date" id="loan_start_date" value="<?php if(isset($editloan)) { if($editloan[0]->loan_startdate!=null && $editloan[0]->loan_startdate!='') echo date('d/m/Y',strtotime($editloan[0]->loan_startdate));} ?>" readonly >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Loan Due Day</label>
                                        <input type="text" class="form-control" name="loan_due_day"  placeholder="Enter Here" id="loan_due_day" value="<?php if(isset($editloan)) { echo $editloan[0]->loan_due_day;} ?>" readonly >
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        ...
                                        <input type="text" class="form-control " id="loan_term"  placeholder="Enter Here" value="<?php if(isset($editloan)) { echo format_money($editloan[0]->loan_term,2);} ?>" readonly >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Interest Type</label>
                                        <input type="text" class="form-control "  placeholder="Enter Here" id="loan_interest_type" value="<?php if(isset($editloan)) { echo $editloan[0]->loan_interest_type;} ?>" readonly >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Interest Rate (In %) </label>
                                        <input type="text" class="form-control " id="loan_interest_rate"  placeholder="Enter Here" value="<?php if(isset($editloan)) { echo format_money($editloan[0]->loan_interest_rate,2);} ?>" readonly >
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        ...
                                        <input type="text" class="form-control " id="financial_institution"  placeholder="Enter Here" value="<?php if(isset($editloan)) { echo $editloan[0]->financial_institution;} ?>"  readonly >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Repayment </label>
                                        <input type="text" class="form-control " id="repayment"  placeholder="Enter Here" value="<?php if(isset($editloan)) { echo $editloan[0]->repayment;} ?>" readonly >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Purpose </label>
                                        <input type="text" class="form-control " id="purpose"  placeholder="Enter Here" value="<?php if(isset($editloan)) { echo $editloan[0]->purpose;} ?>" readonly >
                                    </div>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
                           <?php if(isset($loanD)&& count($loanD)>0){ ?>
                        <div class="a" id="loan_details">
                            <p class="m-t-20"><b>Loan Details</b></p>
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select  class="form-control full-width" id="loan_ref_name" name="loan_id" data-placeholder="Select " data-init-plugin="select2" data-minimum-results-for-search="Infinity">
                                        <?php print_r($loanD);?>
                                        <?php print_r($loanD[0]->loan_ref_id);?>
                                            <?php if(isset($loan_txn)) { if(isset($loanD[0]->loan_ref_id)) { 
                                                for($i=0; $i<count($loan_txn); $i++) {
                                                 $selected=  ($loan_txn[$i]->ref_id==$loanD[0]->loan_ref_id?'selected':'');?>; 
                                                 ?>
                                                    <option value="<?php echo $loan_txn[$i]->txn_id; ?>" <?=$selected?>><?php echo $loan_txn[$i]->ref_id?></option>
                                            <?php } } else { ?>
                                                    <?php for($i=0; $i<count($loan_txn); $i++) { ?>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Loan Ref Name </label>
                                        <input type="text" class="form-control " id="loan_ref_id"  placeholder="Enter Here" value="<?php if(isset($loanD)) { echo $loanD[0]->loan_ref_name;} ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Loan Type</label>
                                        <input type="text" class="form-control " id="loan_type"  placeholder="Enter Here" value="<?php if(isset($loanD)) { echo $loanD[0]->loan_type;} ?>" readonly >
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Amount</label>
                                        <input type="text" class="form-control " id="loan_amount" placeholder="Enter Here" value="<?php if(isset($loanD)) { echo format_money($loanD[0]->loan_amount,2);} ?>" readonly >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default  ">
                                        <label>Loan Start Date</label>
                                        <input id="start_date" type="text" class="form-control "  placeholder="Enter Here" name="loan_start_date" id="loan_start_date" value="<?php if(isset($loanD)) { if($loanD[0]->loan_startdate!=null && $loanD[0]->loan_startdate!='') echo date('d/m/Y',strtotime($loanD[0]->loan_startdate));} ?>" readonly >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Loan Due Day</label>
                                        <input type="text" class="form-control" name="loan_due_day"  placeholder="Enter Here" id="loan_due_day" value="<?php if(isset($loanD)) { echo $loanD[0]->loan_due_day;} ?>" readonly >
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Term (In months) </label>
                                        <input type="text" class="form-control " id="loan_term"  placeholder="Enter Here" value="<?php if(isset($loanD)) { echo format_money($loanD[0]->loan_term,2);} ?>" readonly >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Interest Type</label>
                                        <input type="text" class="form-control "  placeholder="Enter Here" id="loan_interest_type" value="<?php if(isset($loanD)) { echo $loanD[0]->loan_interest_type;} ?>" readonly >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Interest Rate (In %) </label>
                                        <input type="text" class="form-control " id="loan_interest_rate"  placeholder="Enter Here" value="<?php if(isset($loanD)) { echo format_money($loanD[0]->loan_interest_rate,2);} ?>" readonly >
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Financial Institution</label>
                                        <input type="text" class="form-control " id="financial_institution"  placeholder="Enter Here" value="<?php if(isset($loanD)) { echo $loanD[0]->financial_institution;} ?>"  readonly >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Repayment </label>
                                        <input type="text" class="form-control " id="repayment"  placeholder="Enter Here" value="<?php if(isset($loanD)) { echo $loanD[0]->repayment;} ?>" readonly >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label>Purpose </label>
                                        <input type="text" class="form-control " id="purpose"  placeholder="Enter Here" value="<?php if(isset($loanD)) { echo $loanD[0]->purpose;} ?>" readonly >
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="a" id="loan_disbursement">
                                            <p class="m-t-20"><b>Loan Disbursement<b></p>
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default required">
                                        <label> Ref Id </label>
                                        <input type="text" class="form-control" name="ref_id" placeholder="Enter Here" value="<?php if(isset($editloan)) { echo $editloan[0]->ref_id;} ?>" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default ">
                                        <label> Ref Name</label>
                                        <input type="text" class="form-control" name="ref_name" placeholder="Enter Here" value="<?php if(isset($editloan)) { echo $editloan[0]->ref_name;} ?>" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default required">
                                        <label>Disbursement Amount </label>
                                        <input type="text" class="form-control format_number" name="disbursement_amount" id="disbursement_amount" placeholder="Enter Here" value="<?php if(isset($editloan)) { echo format_money($editloan[0]->disbursement_amount,2);} ?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default required ">
                                        ...
                                        <input type="text" class="form-control datepicker" name="disbursement_date" id="disbursement_date" placeholder="Enter Here" value="<?php if(isset($editloan)) { if($editloan[0]->disbursement_date!=null && $editloan[0]->disbursement_date!='') echo date('d/m/Y',strtotime($editloan[0]->disbursement_date));} ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default required">
                                        <label>EMI </label>
                                        <input type="text" class="form-control format_number" name="emi" id="emi" placeholder="Enter Here" value="<?php if(isset($editloan)) { echo format_money($editloan[0]->emi,2);} ?>"/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        <label>Issuer Bank A/C  </label>
                                        <select class="form-control full-width" id="issuer_bank_acc" name="issuer_bank_id" data-placeholder="Select" data-init-plugin="select2" data-minimum-results-for-search="Infinity" data-error="#err_issuer_bank">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="form-control full-width" id="receiver_bank_acc" name="receiver_bank_id" data-placeholder="Select" data-init-plugin="select2" data-minimum-results-for-search="Infinity" data-error="#err_receiver_bank">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="full-width" id="payment_mode" name="payment_mode" data-placeholder="Select" data-init-plugin="select2" data-minimum-results-for-search="Infinity" data-error="#err_payment_mode" >
                                    ...
                                    <table class="view_table addsummary">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:right;"  class="text-right"><?php echo format_money($total_basic_cost,2);?></td>
                                                ...
                                                <table class="view_table addschedule">
                                                    ...
                                                    <tbody id="schedule_table">
                                                        ...
                                                        <tr id="repeat_schedule_<?php echo $i+1; ?>">
                                                            ...
                                                            <td class="text-right"><input type="text"   name="sch_basiccost[]" value="<?php echo format_money($basic_cost,2);?>" class="form-control format_number" style="border:none; "/></td>
