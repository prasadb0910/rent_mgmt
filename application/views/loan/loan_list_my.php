            ...
            <div id="rootwizard">
                <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist" data-init-reponsive-tabs="dropdownfx">
                    ...
                    <li class="nav-item inprocess">
                        <a class="<?php if($checkstatus=='InProcess') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/Loan/checkstatus/InProcess">IN Process(<?php echo $inprocess; ?>)</a>
                    </li>
                </ul>
                <br>
                            ...
                            <div class="col-md-12">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="all">
                                        ...
                                        <div>
                                            <a href="<?php echo base_url(); ?>index.php/Loan/addnew"><button class="btn btn-default pull-right" type="submit"><i class="fa fa-plus tab-icon"></i> <span>Add Property</span></button></a>
                                        </div>
                                        <br>
                                        <div class="row grid">
                                                ...
                                                <div class="card card-transparent container-fixed-lg bg-white " style="background:#fff;">
                                                    <div class="row">
                                                        ...
                                                        <div class="prop_btns">
                                                            ...
                                                            <div class="pull-left" style="margin-top: 40px;padding-left: 20px;">
                                                                <a href="<?php echo base_url(); ?>index.php/Loan_disbursement" data-toggle="tooltip" data-placement="bottom" title="Maintenance"><i style="font-size:22px;" class="fa fa-file-text-o"></i></a>
                                                            </div>
                                                        </div>
