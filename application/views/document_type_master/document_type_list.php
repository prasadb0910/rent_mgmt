...
.btn-delete{ font-size:20px;  color: #333; padding: 0;	  }
...
.dataTables_paginate { margin:5px 0 0 0; }
</style>
    </head>
    <body>								
        ...
        <div class="page-container page-navigation-top">            
            <!-- PAGE CONTENT -->
             <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
               ...
               <div class="heading-h2-heading">  	 <a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; Document Type Master List   </div>  
			    <div class="heading-h2-heading"> 
						<div class="btn-top">
                    	<div class="pull-left ">
										 <a class="btn btn-success btn-block" href="<?php echo base_url().'index.php/document_type_master/addDocumentType'; ?>">
												<span class="fa fa-plus"></span> Add Document Type
											</a>
				</div>	      
                </div>	 
				</div>  
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row main-wrapper">
						...
						<!-- 	<div class="panel-heading">
								<h3 class="panel-title"><strong>Document Type Master List</strong></h3>
								...
								<table id="customers2" class="table datatable table-bordered" style="border-top:none;">
									...
									<tbody>
										...
										<tr id="trow_1">
											...
											<td><a href="<?php echo base_url().'index.php/Document_type_master/editRecord/'.$document_type[$i]->d_type_id; ?>"><?php echo $document_type[$i]->d_type ; ?></a></td>
											<td><?php echo $document_type[$i]->d_m_status; ?></td>
											<td style="text-align:center; padding:0;">
												<a onclick="return confirm('Are you sure you want to delete this item?');" class="btn-delete" href="<?php echo base_url().'index.php/Document_type_master/deleteRecord/'.$document_type[$i]->d_type_id; ?>"> <i class="fa fa-trash-o" aria-hidden="true"></i> </a>
											</td>
										</tr>
										<?php } ?>
									</tbody>
