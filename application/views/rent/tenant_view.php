												...
												<div class="col-md-12 col-sm-4">
													<div class="transaction-item">
														<div class="view-block m-b-0">
															...
															<div class="title-block">
																<h4>Lockin Period</h4>
																<span class="period"><?php echo $editrent[0]->lease_period; ?><?php if($editrent[0]->lease_period >1) echo " months"; else echo " month" ?></span>
															</div>
															<div class="title-block">
																<h4>Notice Period </h4>
																<span class="period"><?php echo $editrent[0]->notice_period; ?><?php if($editrent[0]->notice_period >1) echo " months"; else echo " month" ?></span>
															</div>
															<div class="title-block">
																<h4>Rent Free Period</h4>
																<span class="period"><?php echo $editrent[0]->free_rent_period; ?><?php if($editrent[0]->free_rent_period >1) echo " months"; else echo " month" ?></span>
															</div>
														</div>
													</div>
												</div>
