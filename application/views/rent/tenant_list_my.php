            ...
            <div id="rootwizard">
                <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist" data-init-reponsive-tabs="dropdownfx">
                    <li class="nav-item all">
                        <a class="<?php if($checkstatus=='All') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/rent/checkstatus/All">All(<?php echo $all; ?>)</a>
                    </li>
                    <li class="nav-item approved">
                        <a class="<?php if($checkstatus=='Approved') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/rent/checkstatus/Approved">Approved(<?php echo $approved; ?>)</a>
                    </li>
                    <li class="nav-item pending">
                        <a class="<?php if($checkstatus=='Pending') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/rent/checkstatus/Pending">Pending(<?php echo $pending; ?>)</a>
                    </li>
                    <li class="nav-item rejected">
                        <a class="<?php if($checkstatus=='Rejected') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/rent/checkstatus/Rejected">Rejected(<?php echo $rejected; ?>)</a>
                    </li>
                    <li class="nav-item inprocess">
                        <a class="<?php if($checkstatus=='InProcess') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/rent/checkstatus/InProcess">IN Process(<?php echo $inprocess; ?>)</a>
                    </li>
                </ul>
                <br>
                                            ...
                                            <div class=" col-md-6">
                                                <div class="markup">
                                                    <div class="card card-transparent container-fixed-lg bg-white " style="background:#fff;">
                                                        <div class="row">
                                                            <div class=" col-md-4">
                                                                <img src="<?php echo base_url().$rent[0]->p_image; ?>" alt="Paris" class="prop_img m-t-20 m-l-20" style="width:180px">
                                                            </div>
                                                            <div class=" col-md-8">
                                                                ...
                                                                <div class="card-block">
                                                                    <p class=" flat_info m-t-0 m-b-0"><?php echo $rent[$i]->p_type . ', ' . $rent[$i]->pr_agreement_area . ' ' . $rent[$i]->pr_agreement_area . ', ' . $rent[$i]->p_status; ?></p>
                                                                    <p class="avaibility m-t-0 m-b-0">Vacant</p>
                                                                    <div class="building_name"><b><?php echo $rent[$i]->p_display_name; ?></b></div>
                                                                    <div class="address"><i class="fa fa-map-marker"></i><?php if(isset($rent)) { echo $rent[0]->p_apartment . ' ' . $rent[0]->p_flatno . ' ' . $rent[0]->p_floor . ' ' . $rent[0]->p_wing . ' ' . $rent[0]->p_address . ' ' . $rent[0]->p_landmark . ' ' . $rent[0]->p_state . ' ' . $rent[0]->p_city . ' ' . $rent[0]->p_pincode . ' ' . $rent[0]->p_country; } ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <br>
                                            ...
                                            <div class=" col-md-12">
                                                <div class="card card-transparent container-fixed-lg bg-white " style="background:#fff;">
                                                    <div class="row">
                                                        ...
                                                        <p class=" flat_info m-t-0 m-b-0 pull-left" style="margin-top: 45px;padding-left: 20px;"><?php echo $rent[$i]->p_type . ', ' . $rent[$i]->pr_agreement_area . ' ' . $rent[$i]->pr_agreement_area . ', ' . $rent[$i]->p_status; ?></p>
