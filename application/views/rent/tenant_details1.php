                                ...
                                <div class="row clearfix recurring">
                                    ...
                                    <div class="col-md-3" style="padding-left: 7px;">
                                        <div class="form-group form-group-default form-group-default-select2 input-group gst">
                                            <div class="form-input-group">
                                                ...
                                                <select class="full-width" name="gst_rate" id="gst_rate" <?php if(isset($editrent)) { if($editrent[0]->gst==1) echo ''; else echo 'disabled'; } else echo 'disabled'; ?> onchange="instchange(); opentable(); set_tax();" data-placeholder="Select" data-init-plugin="select2" data-minimum-results-for-search="Infinity">
                                                    <option value="">Select</option>
                                                    <?php 
                                                        $selected='';
                                                        if(isset($tax)){
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group form-group-default input-group">
                                            <div class="form-input-group">
                                                <label style="float:left!important;">TDS Rate In %</label>
                                                <input type="text" class="form-control format_number" name="tds_rate" id="tds_rate" placeholder="Enter Here" value="<?php if(isset($editrent)) { if(count($editrent)>=0) { echo format_money($editrent[0]->tds_rate,2); }} ?>" <?php if(isset($editrent)) { if($editrent[0]->tds==1) echo ''; else echo 'readonly'; } else echo 'readonly'; ?> />
                                            </div>
                                            <div class="input-group-addon bg-transparent h-c-50">
                                                ...
                                                <div class="col-md-3" style="padding-left: 7px;">
                                                    <div class="form-group form-group-default form-group-default-select2 input-group gst">
                                                        <div class="form-input-group">
                                                            ...
                                                            <select class="full-width select2" id="gst_rate_<?php echo $j+1; ?>" data-placeholder="Select" data-init-plugin="select2" <?php if(isset($other_amt_details)) { if($other_amt_details[$j]->gst==1) echo ''; else echo 'disabled'; } else echo 'disabled'; ?> onChange="set_gst_rate_val(this);" >
                                                            <option value="">Select</option>
                                                            <?php 
                                                                if(isset($tax)){
                                                                    foreach($tax as $row){
