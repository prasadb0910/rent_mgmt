                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-default form-group-default-select2 required" id="subproperty" style="display:none;">
                                        ...
                                        <select class="form-control full-width" id="sub_property" name="sub_property" data-placeholder="Select" data-init-plugin="select2" data-minimum-results-for-search="Infinity" data-error="#sub_property_error">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <div class="form-group form-group-default ">
                                        ...
                                        <input type="text" class="form-control date2" id="sale_date" name="sale_date" placeholder="Enter Here" value="<?php if(isset($s_txn)) { if(count($s_txn)>0) {echo date('d/m/Y',strtotime($s_txn[0]->date_of_sale));}} ?>" />
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-default ">
                                        ...
                                        <input type="text" class="form-control format_number" id="indexed_cost" name="indexed_cost" placeholder="Enter Here" value="<?php if(isset($s_txn)) { if(count($s_txn)>0) { echo format_money($s_txn[0]->indexed_cost,2); } } ?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
