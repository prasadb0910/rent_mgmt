							...
							<div class=" container-fluid container-fixed-lg bg-white">
			                    <div class="card card-transparent">
			                                ...
			                                <div id="repeat_owner_<?php echo $j+1; ?>" class="row clearfix">
			                                    <div class="col-md-5">
			                                        <div class="form-group form-group-default form-group-default-select2">
			                                            ...
			                                            <select id="owner_name_<?php echo $j+1; ?>" name="clientname[]" class="form-control ownership full-width" data-error="#err_owner_name_<?php echo $j+1; ?>"  data-init-plugin="select2" disabled>
			                                    ...
			                                    <div class="col-md-5">
			                                        <div class="form-group form-group-default">
			                                            ...
			                                            <input type="text" id="owner_percent_<?php echo $j+1; ?>" name="ownership[]" class="form-control" value="<?php if(isset($p_ownership[$j]->pr_ownership_percent)){ echo format_money($p_ownership[$j]->pr_ownership_percent,2); } else { echo ''; }?>" readonly />
			                                        </div>
			                                    </div>
			                                </div>
			                            ...
			                            <div class="row clearfix">
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default">
			                                        ...
			                                        <input type="text" class="form-control" id="property_name" name="property_name"  value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_property_name; } ?>" readonly />
			                                    </div>
			                                </div>
			                            ...
			                            <div class="row clearfix">
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default">
			                                        ...
			                                        <input type="text" class="form-control" name="date_of_purchase"  value="<?php if(isset($p_txn)) { echo ($p_txn[0]->p_purchase_date!=null && $p_txn[0]->p_purchase_date!='')?date('d/m/Y',strtotime($p_txn[0]->p_purchase_date)):''; } ?>" readonly />
			                                    </div>
			                                </div>
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default form-group-default-select2">
			                                        <label class=""> Mode </label>
			                                        <select class="form-control full-width" name="purchase_mode" data-error="#err_purchase_mode"  data-init-plugin="select2" disabled>
			                            ...
			                            <div class="row clearfix">
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default form-group-default-select2">
			                                        ...
			                                        <select class="form-control full-width" id="ptype" name="property_type" data-error="#err_property_type" data-init-plugin="select2" disabled>
			                                ...
			                                <div class="col-md-6 p_status">
			                                    <div class="form-group form-group-default form-group-default-select2">
			                                        ...
			                                        <select class="form-control full-width" name="property_status" id="property_status" data-error="#err_property_status"  data-init-plugin="select2" disabled>
			                            ...
			                            <div class="row clearfix">
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default form-group-default-select2">
			                                        ...
			                                        <select id="builder" name="builder_name" class="form-control full-width" data-error="#err_builder_name"  data-init-plugin="select2" disabled>
			                                ...
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default form-group-default-select2">
			                                        ...
			                                        <select class="form-control full-width" name="property_usage" data-error="#err_property_usage"  data-init-plugin="select2" disabled>
			                            ...
			                            <div class="row clearfix">
			                                <div class="col-md-12">
			                                    <div class="form-group form-group-default">
			                                        ...
			                                        <input type="text" class="form-control" name="property_description" value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_propertydescription; } ?>" readonly />
			                                    </div>
			                                </div>
			                            </div>
			                        </div>
			                            ...
			                            <div class="row clearfix">
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default">
			                                        ...
			                                        <input type="text" class="form-control" name="apartment_name"  value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_apartment; } ?>" readonly />
			                                    </div>
			                                </div>
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default">
			                                        <label>Unit No</label>
			                                        <input type="text" class="form-control" name="flat_no" value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_flatno; } ?>" readonly />
			                                    </div>
			                                </div>
			                            </div>
			                            <div class="row clearfix">
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default">
			                                        <label>Floor</label>
			                                        <input type="text" class="form-control" name="floor"value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_floor; } ?>" readonly />
			                                    </div>
			                                </div>
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default">
			                                        <label>Wing</label>
			                                        <input type="text" class="form-control" name="wing"  value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_wing; } ?>" readonly />
			                                    </div>
			                                </div>
			                            </div>
			                            <div class="row clearfix">
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default">
			                                        <label>Address</label>
													<span class="label_addr"><?php if(isset($p_txn)) { echo $p_txn[0]->p_address; } ?></span>
			                                ...
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default">
			                                        ...
			                                        <input type="text" class="form-control" name="landmark"  value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_landmark; } ?>" readonly />
			                                    </div>
			                                </div>
			                            </div>
			                            <div class="row clearfix">
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default">
			                                        <label>City </label>
			                                        <input type="text" class="form-control" name="city" id ="pur_add_city"  value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_city; } ?>" readonly />
			                                    </div>
			                                </div>
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default">
			                                        <label>Pincode </label>
			                                        <input type="text" class="form-control" name="pincode" value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_pincode; } ?>" readonly />
			                                    </div>
			                                </div>
			                            </div>
			                            <div class="row clearfix">
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default">
			                                        <label>State</label>
			                                        <input type="text" class="form-control" name="state" id="pur_add_state"  value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_state; } ?>" readonly />
			                                    </div>
			                                </div>
			                                <div class="col-md-6">
			                                    <div class="form-group form-group-default">
			                                        <label>Country </label>
			                                        <input type="text" class="form-control" name="country" id="pur_add_country"  value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_country; } ?>" readonly />
			                                    </div>
			                                </div>
			                            </div>
			                            <div class="row clearfix">
			                                <div class="col-md-9">
			                                    <div class="form-group form-group-default">
			                                        ...
			                                        <input type="text" id="googlemaplink" class="form-control" name="googlemaplink"  value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_googlemaplink; } ?>" readonly />
			                                    </div>
			                                </div>
			                            </div>
			                        </div>
			                        <div class="a" id="">
			                            ...
			                            <div class="row clearfix">
			                            	<?php 
			                          		if($p_description[0]->pr_agreement_area!=0 && $p_description[0]->pr_agreement_unit!=""){?>
			                                <div class="col-md-4">
			                                    <div class="form-group form-group-default">
			                                        <label>Agreement Area </label>
			                                        <input type="text" id="agreement_area" class="form-control format_number" name="agreement_area"  value="<?php if(isset($p_description)) { if(count($p_description)>0) { echo format_money($p_description[0]->pr_agreement_area,2). ' ' .$p_description[0]->pr_agreement_unit; }} ?>" readonly />
			                                    </div>
			                                </div>
			                          		<?php 
			                          		}
			                          		if($p_description[0]->pr_land_area!=0 && $p_description[0]->pr_land_unit!=""){?>
			                                <div class="col-md-4 land_area">
			                                    <div class="form-group form-group-default">
			                                        <label>Land Area </label>
			                                        <input type="text" class="form-control format_number" name="land_area"  value="<?php if(isset($p_description)) { if(count($p_description) > 0) { echo format_money($p_description[0]->pr_land_area,2). ' ' .$p_description[0]->pr_land_unit;} }?>" readonly />
			                                    </div>
			                                </div>
			                                <?php } ?>
											
											<?php 
			                            		if($p_description[0]->pr_carpet_area!=0 && $p_description[0]->pr_carpet_unit!=""){?>
											  <div class="col-md-4 carpet_area">
			                                    <div class="form-group form-group-default">
			                                        <label>Carpet  Area</label>
			                                        <input type="text" class="form-control format_number" name="carpet_area" value="<?php if(isset($p_description)) { if(count($p_description)>0) { echo format_money($p_description[0]->pr_carpet_area,2). ' ' .$p_description[0]->pr_carpet_unit; }} ?>" readonly />
			                                    </div>
			                                </div>
			                                <?php } ?>
			                                </div>
			                            ...
			                            <div class="row clearfix built_up_saleable_area">
			                              <?php 
			                            	if($p_description[0]->pr_builtup_area!=0 && $p_description[0]->pr_builtup_unit!=""){?>
			                               
			                                <div class="col-md-4 built_up_area">
			                                    <div class="form-group form-group-default">
			                                        <label>Built Up Area </label>
			                                        <input type="text" class="form-control format_number" name="built_area" value="<?php if(isset($p_description)) { if(count($p_description)>0) { echo format_money($p_description[0]->pr_builtup_area,2). ' ' .$p_description[0]->pr_builtup_unit; }} ?>" readonly />
			                                    </div>
			                                </div>
			                           
			                         	<?php }
			                            	if($p_description[0]->pr_sellable_area!=0 && $p_description[0]->pr_sellable_unit!=""){?>
			                         
			                                <div class="col-md-4 saleable_area">
			                                    <div class="form-group form-group-default">
			                                        <label>Saleable Area </label>
			                                        <input type="text" class="form-control format_number" name="sell_area"  value="<?php if(isset($p_description)) { if(count($p_description)>0) { echo format_money($p_description[0]->pr_sellable_area,2). ' ' . $p_description[0]->pr_sellable_unit; } }?>" readonly />
			                                    </div>
			                                </div>

			                             <?php }
			                            	if($p_description[0]->pr_bunglow_area!=0 && $p_description[0]->pr_bunglow_unit!=""){?>
			                                <div class="col-md-4 bunglow_building_area">
			                                    <div class="form-group form-group-default">
			                                        <label>Bunglow  Area </label>
			                                        <input type="text" class="form-control format_number" name="bunglow_area"  value="<?php if(isset($p_description)) { if(count($p_description)>0) { echo format_money($p_description[0]->pr_bunglow_area,2). ' ' .$p_description[0]->pr_bunglow_unit; } }?>" readonly />
			                                    </div>
			                                </div>
			                            ...
			                            <div class="row clearfix building_area">
			                            	<?php 
			                            	if($p_description[0]->pr_no_of_floors!=0 && $p_description[0]->pr_no_of_floors!=""){?>
			                                <div class="col-md-4">
			                                    <div class="form-group form-group-default">
			                                        <label>No Of Floors</label>
			                                        <input type="text" class="form-control format_number" name="no_of_floors"  value="<?php if(isset($p_description)) {if(count($p_description)>0) {  echo format_money($p_description[0]->pr_no_of_floors,2); }} ?>" readonly />
			                                    </div>
			                                </div>
			                                <?php }
			                                if($p_description[0]->pr_no_of_flats!=0 && $p_description[0]->pr_no_of_flats!=""){?>
			                             

			                                <div class="col-md-4">
			                                    <div class="form-group form-group-default">
			                                        <label>No Of Flats</label>
			                                        <input type="text" class="form-control format_number" name="no_of_flats" value="<?php if(isset($p_description)) {if(count($p_description)>0) {  echo format_money($p_description[0]->pr_no_of_flats,2); }} ?>" readonly />
			                                    </div>
			                                </div>
			                                <?php }
			                                	if($p_description[0]->pr_no_of_shops!=0 && $p_description[0]->pr_no_of_shops!=""){?>
			                                	
			                                <div class="col-md-4">
			                                    <div class="form-group form-group-default">
			                                        <label>No Of Shops</label>
			                                        <input type="text" class="form-control format_number" name="no_of_shops"  value="<?php if(isset($p_description)) {if(count($p_description)>0) {  echo format_money($p_description[0]->pr_no_of_shops,2); }} ?>" readonly />
			                                    </div>
			                                </div>
			                                <?php } ?>
			                            </div>
			                            <div class="row clearfix parking_div">
			                            	<?php
			                                	if($p_description[0]->pr_open_parking!=0 && $p_description[0]->pr_open_parking!=""){?>
			                                <div class="col-md-4">
			                                    <div class="form-group form-group-default">
			                                        <label>No Of Open Parking </label>
			                                        <input type="text" class="form-control format_number" name="open_parking"value="<?php if(isset($p_description)) {if(count($p_description)>0) {  echo format_money($p_description[0]->pr_open_parking,2); }} ?>" readonly />
			                                    </div>
			                                </div>
			                                <?php }  if($p_description[0]->pr_covered_parking!=0 && $p_description[0]->pr_covered_parking!=""){?>
			                                <div class="col-md-4">
			                                    <div class="form-group form-group-default">
			                                        <label>No Of Covered Parking </label>
			                                        <input type="text" class="form-control format_number" name="covered_parking" value="<?php if(isset($p_description)) {if(count($p_description)>0) {  echo format_money($p_description[0]->pr_covered_parking,2); }} ?>" readonly />
			                                    </div>
			                                </div>
			                                <?php } ?>
										<div class="col-md-4">
			                                ...
			                                <div id="repeat_img_<?php echo $i+1; ?>" class="row clearfix">
			                                    <div class="col-md-4">
			                                        <div class="form-group form-group-default ">
			                                            ...
			                                            <input type="text" class="form-control date prop_description" name="capture_date[]"  value="<?php echo ($p_description_img[$i]->file_date!=null && $p_description_img[$i]->file_date!='')?date('d/m/Y',strtotime($p_description_img[$i]->file_date)):''; ?>" readonly />
			                                        </div>
			                                    </div>
			                                    <div class="col-md-4">
			                                        <div class="form-group form-group-default ">
			                                            <label>Description</label>
			                                            <input type="text" class="form-control" name="capture_description[]"  value="<?php echo $p_description_img[$i]->file_description; ?>" readonly />
			                                        </div>
			                                    </div>
			                                    <div class="col-md-3"> 
			                    ...
			                    <div class="a">
			                        <p class=""><b>Property Amenities</b></p>
