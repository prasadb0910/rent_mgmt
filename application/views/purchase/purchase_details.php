    ...
    <div class=" container-fluid   container-fixed-lg ">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/Purchase/checkstatus/All">Purchase List</a></li>
                 <?php if(isset($p_txn)){ ?><li class="breadcrumb-item"><a href="<?php if (isset($p_id)) echo base_url().'index.php/Purchase/view/'.$p_id; ?>">Purchase View</a></li>
				  <?php } ?>
                ...
                <div class=" container-fluid container-fixed-lg bg-white">
                    <div class="card card-transparent">
                            ...
                            <div id="repeatowner">
                                ...
                                <div id="repeat_owner_<?php echo $j+1; ?>" class="row clearfix">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input type="text" id="owner_percent_<?php echo $j+1; ?>" name="ownership[]" class="form-control" placeholder="Enter Here" value="<?php if(isset($p_ownership[$j]->pr_ownership_percent)){ echo format_money($p_ownership[$j]->pr_ownership_percent,2); } else { echo ''; }?>"/>
                                        </div>
                                    </div>
                                ...
                                <div id="repeat_owner_<?php echo $j+1; ?>" class="row clearfix">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group form-group-default">
                                            <label>% of Ownership</label>
                                            <input type="text" id="owner_percent_<?php echo $j+1; ?>" name="ownership[]" class="form-control"  placeholder="Enter Here" value=""/>
                                        </div>
                                    </div>
                                    <div class="delete delete_row" id="repeat_owner_<?php echo $j+1; ?>_delete"><i class="fa fa-trash" aria-hidden="true"></i></div>
                                </div>
                     ...
                     <p class="m-t-20"><b>General Information</b></p>
                        <div class="a" id="general_info">
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <div class="form-group form-group-default required">
                                        <label>Property Name</label>
                                        <input type="text" class="form-control" id="property_name" name="property_name"  placeholder="Enter Here" value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_property_name; } ?>" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <div class="form-group form-group-default required">
                                        ...
                                        <input type="text" class="form-control datepicker" name="date_of_purchase"  placeholder="Enter Here" value="<?php if(isset($p_txn)) { echo ($p_txn[0]->p_purchase_date!=null && $p_txn[0]->p_purchase_date!='')?date('d/m/Y',strtotime($p_txn[0]->p_purchase_date)):''; } ?>" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        <label class="">Mode </label>
                                        <select class="form-control full-width" name="purchase_mode" data-error="#err_purchase_mode" data-placeholder="Select" data-init-plugin="select2" data-minimum-results-for-search="Infinity">
                                            <option value="">Select</option>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        ...
                                        <select class="form-control full-width" id="ptype" name="property_type" data-error="#err_property_type" data-placeholder="Select" data-minimum-results-for-search="Infinity" data-init-plugin="select2" onchange="set_type(this);">
                                            <option value="">Select</option>
                                ...
                                <div class="col-md-6 p_status">
                                    <div class="form-group form-group-default form-group-default-select2">
                                        ...
                                        <select class="form-control full-width" name="property_status" id="property_status" data-error="#err_property_status" data-placeholder="Select" data-init-plugin="select2" data-minimum-results-for-search="Infinity">
                                            <option value="">Select</option>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-6">
                                    <div class="form-group form-group-default form-group-default-select2">
                                        ...
                                        <select id="builder" name="builder_name" class="form-control full-width" data-error="#err_builder_name" data-placeholder="Select " data-init-plugin="select2">
                                            <option value="">Select</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        <label class="">Usage of Property </label>
                                        <select class="form-control full-width" name="property_usage" data-error="#err_property_usage" data-placeholder="Select" data-init-plugin="select2" data-minimum-results-for-search="Infinity">
                                            <option value="">Select</option>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-12">
                                    <div class="form-group form-group-default required">
                                        ...
                                        <input type="text" class="form-control" name="property_description"  placeholder="Enter Here" value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_propertydescription; } ?>"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="a propaddr" id="address_info" style="display:none;">
                            <p class="m-t-20"><b>Address Details<b></p>
                            <div class="row clearfix aptname">
                                <div class="col-md-6 buldname aptdesc">
                                    <div class="form-group form-group-default">
                                        <label>Building Name</label>
                                        <input type="text" class="form-control" name="apartment_name"  placeholder="Enter Here"  value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_apartment; } ?>"/>
                                    </div>
                                </div>
                                <div class="col-md-6 aptdesc">
                                    <div class="form-group form-group-default">
                                        <label>Unit No</label>
                                        <input type="text" class="form-control" name="flat_no"  placeholder="Enter Here" value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_flatno; } ?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix aptname aptdesc">
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        <label>Floor</label>
                                        <input type="text" class="form-control" name="floor"  placeholder="Enter Here" value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_floor; } ?>"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        <label>Wing</label>
                                        <input type="text" class="form-control" name="wing"  placeholder="Enter Here" value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_wing; } ?>" />
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-8">
                                    <div class="form-group form-group-default required">
                                        <label>Address</label>
                                        <input type="text" class="form-control" name="address"  placeholder="Enter Here" value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_address; } ?>"/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default">
                                        <label>Landmark </label>
                                        <input type="text" class="form-control" name="landmark"  placeholder="Enter Here" value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_landmark; } ?>"/>
                                    </div>
                                </div>
                            </div>
                             <div class="row clearfix">
                                <div class="col-md-6 city">
                                    <div class="form-group form-group-default form-group-default-select2">
                                     <label class="">City</label>
                                        <select class="full-width" name="city" id="pur_add_city" class="form-control nm_name full-width" data-placeholder="Select" data-init-plugin="select2" data-error="#err_city">
                                            <option value="">Select</option>
                                            <?php
                                                $opt = '';
                                                foreach($city as $cities)
                                                {   
                                                  $opt.="<option value='".$cities['city_name']."' data-id='".$cities['id']."'".($p_txn[0]->p_city==$cities['city_name']?'selected':'').">".$cities['city_name']."</option>";
                                                }
                                                echo $opt;
                                            ?>
                                   ...
                                   <!--<div class="form-group form-group-default required">
                                        <label>City </label>
                                        <input type="text" class="form-control" name="city" id ="pur_add_city"  placeholder="Enter Here" value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_city; } ?>"/>
                                    </div>-->
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-group-default required">
                                        <label>Pincode </label>
                                        <input type="text" class="form-control" name="pincode"  placeholder="Enter Here" value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_pincode; } ?>"/>
                                    </div>
                                </div>
                            </div>
                           <div class="row clearfix">
                                <div class="col-md-6">
                                    <div class="form-group form-group-default required">
                                        <label>State</label>
                                        <input type="text" class="form-control" name="state" id="pur_add_state" placeholder="Enter Here" value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_state; } ?>" readonly/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-group-default required">
                                        <label>Country </label>
                                        <input type="text" class="form-control" name="country" id="pur_add_country"  placeholder="Enter Here"value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_country; } ?>" readonly/>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                <div class="col-md-9">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input type="text" id="googlemaplink" class="form-control" name="googlemaplink"  placeholder="Enter Here"onFocus="geolocate()" value="<?php if(isset($p_txn)) { echo $p_txn[0]->p_googlemaplink; } ?>"/>
                                    </div>
                                </div>
                                <div class="col-md-3">
                        ...
                        <div class="a propdesc" id="property_desc" style="display:none;">
                            <p class="m-t-20"><b>Property Description<b></p>
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default required">
                                        <label>Agreement Area </label>
                                        <input type="text" id="agreement_area" class="form-control format_number" name="agreement_area"  placeholder="Enter Here" value="<?php if(isset($p_description)) { if(count($p_description)>0) { echo format_money($p_description[0]->pr_agreement_area,2); }} ?>" />
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group form-group-default form-group-default-select2 required">
                                        <label class="">Select Unit</label>
                                        <select id="ddlagreementarea" class="form-control full-width" name="agreement_unit" data-error="#err_agreement_unit" data-placeholder="Select " data-init-plugin="select2" data-minimum-results-for-search="Infinity">
                            ...
                            <div class="row clearfix">
                                <div class="col-md-4 land_area">
                                    <div class="form-group form-group-default">
                                        <label>Land Area </label>
                                        <input type="text" class="form-control format_number" name="land_area"  placeholder="Enter Here"value="<?php if(isset($p_description)) { if(count($p_description) > 0) { echo format_money($p_description[0]->pr_land_area,2); } }?>" />
                                    </div>
                                </div>
                                <div class="col-md-2 land_area">
                                    <div class="form-group form-group-default form-group-default-select2">
                                        <label class="">Select Unit</label>
                                        <select class="form-control full-width" name="land_unit" data-error="#err_land_unit" data-placeholder="Select " data-init-plugin="select2" data-minimum-results-for-search="Infinity">
                                            <option value="">Select Unit</option>
                                ...
                                <div class="col-md-4 carpet_area" style="padding-left: 0;">
                                    <div class="form-group form-group-default">
                                        <label>Carpet Area </label>
                                        <input type="text" class="form-control format_number" name="carpet_area"  placeholder="Enter Here"value="<?php if(isset($p_description)) { if(count($p_description)>0) { echo format_money($p_description[0]->pr_carpet_area,2); }} ?>"/>
                                    </div>
                                </div>
                                <div class="col-md-2 carpet_area" style="padding-right: 7px;">
                                    <div class="form-group form-group-default form-group-default-select2">
                                        <label class="">Select Unit</label>
                                        <select class="form-control full-width" name="carpet_unit" data-error="#err_carpet_unit" data-placeholder="Select" data-init-plugin="select2" data-minimum-results-for-search="Infinity">
                                            <option value="">Select Unit</option>
                            ...
                            <div class="row clearfix built_up_saleable_area">
                                <div class="col-md-4 built_up_area">
                                    <div class="form-group form-group-default">
                                        <label>Built Up Area </label>
                                        <input type="text" class="form-control format_number" name="built_area"  placeholder="Enter Here"value="<?php if(isset($p_description)) { if(count($p_description)>0) { echo format_money($p_description[0]->pr_builtup_area,2); }} ?>"/>
                                    </div>
                                </div>
                                <div class="col-md-2 built_up_area">
                                    <div class="form-group form-group-default form-group-default-select2">
                                        <label class="">Select Unit</label>
                                        <select  class="form-control full-width" name="built_unit" data-error="#err_built_unit" data-placeholder="Select" data-init-plugin="select2" data-minimum-results-for-search="Infinity">
                                            <option value="">Select Unit</option>
                                ...
                                <div class="col-md-4 saleable_area" style="padding-left: 0;">
                                    <div class="form-group form-group-default">
                                        <label>Saleable Area </label>
                                        <input type="text" class="form-control format_number" name="sell_area" placeholder="Enter Here"value="<?php if(isset($p_description)) { if(count($p_description)>0) { echo format_money($p_description[0]->pr_sellable_area,2); } }?>"/>
                                    </div>
                                </div>
                                <div class="col-md-2 saleable_area" style="padding-right: 7px;">
                                    <div class="form-group form-group-default form-group-default-select2">
                                        <label class="">Select Unit</label>
                                        <select class="form-control full-width" name="sell_unit" data-error="#err_sell_unit" data-placeholder="Select" data-init-plugin="select2" data-minimum-results-for-search="Infinity">
                                            <option value="">Select Unit</option>
                            ...
                            <div class="row clearfix bunglow_building_area">
                                <div class="col-md-4 bunglow_area">
                                    <div class="form-group form-group-default">
                                        <label>Bunglow  Area </label>
                                        <input type="text" class="form-control format_number" name="bunglow_area" placeholder="Enter Here" value="<?php if(isset($p_description)) { if(count($p_description)>0) { echo format_money($p_description[0]->pr_bunglow_area,2); } }?>"/>
                                    </div>
                                </div>
                                <div class="col-md-2 bunglow_area">
                                    <div class="form-group form-group-default form-group-default-select2">
                                        <label class="">Select Unit</label>
                                        <select class="form-control full-width" name="bunglow_unit" data-error="#err_bunglow_unit" data-placeholder="Select" data-init-plugin="select2" data-minimum-results-for-search="Infinity">
                                            <option value="">Select Unit</option>
                            ...
                            <div class="row clearfix building_area">
                                <div class="col-md-4">
                                    <div class="form-group form-group-default">
                                        <label>No Of Floors</label>
                                        <input type="text" class="form-control format_number" name="no_of_floors" placeholder="Enter Here" value="<?php if(isset($p_description)) {if(count($p_description)>0) {  echo format_money($p_description[0]->pr_no_of_floors,2); }} ?>"/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default">
                                        <label>No Of Flats</label>
                                        <input type="text" class="form-control format_number" name="no_of_flats" placeholder="Enter Here"value="<?php if(isset($p_description)) {if(count($p_description)>0) {  echo format_money($p_description[0]->pr_no_of_flats,2); }} ?>"/>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group form-group-default">
                                        <label>No Of Shops</label>
                                        <input type="text" class="form-control format_number" name="no_of_shops"  placeholder="Enter Here"value="<?php if(isset($p_description)) {if(count($p_description)>0) {  echo format_money($p_description[0]->pr_no_of_shops,2); }} ?>"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix parking_div">
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        <label>No Of Open Parking </label>
                                        <input type="text" class="form-control format_number" name="open_parking"  placeholder="Enter Here" value="<?php if(isset($p_description)) {if(count($p_description)>0) {  echo format_money($p_description[0]->pr_open_parking,2); }} ?>"/>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        <label>No Of Covered Parking </label>
                                        <input type="text" class="form-control format_number" name="covered_parking" placeholder="Enter Here" value="<?php if(isset($p_description)) {if(count($p_description)>0) {  echo format_money($p_description[0]->pr_covered_parking,2); }} ?>"/>
                                    </div>
                                </div>
                            </div>
                            </div>
						<div class="a">
						   <p class="m-t-20"><b>Property images<b></p>
                            <div id="repeatimg">
                                <?php 
                                ...
                                <div id="repeat_img_<?php echo $i+1; ?>" class="row clearfix">
                                    <div class="col-md-3">
                                        <div class="form-group form-group-default ">
                                            ...
                                            <input type="text" class="form-control datepicker prop_description" name="capture_date[]"  placeholder="Enter Here" value="<?php echo ($p_description_img[$i]->file_date!=null && $p_description_img[$i]->file_date!='')?date('d/m/Y',strtotime($p_description_img[$i]->file_date)):''; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group form-group-default ">
                                            <label>Description</label>
                                            <input type="text" class="form-control" name="capture_description[]"  placeholder="Enter Here"value="<?php echo $p_description_img[$i]->file_description; ?>"/>
                                        </div>
                                    </div>
                                    <div class="col-md-5"> 
                                ...
                                <div id="repeat_img_<?php echo $i+1; ?>" class="row clearfix">
                                    <div class="col-md-3">
                                        <div class="form-group form-group-default ">
                                            <label>Captured Date</label>
                                            <input type="text" class="form-control datepicker prop_description" name="capture_date[]"  placeholder="Enter Here" value="" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group form-group-default ">
                                            <label>Description</label>
                                            <input type="text" class="form-control" name="capture_description[]" placeholder="Enter Here"value="" />
                                        </div>
                                    </div>
                                    <div class="col-md-5"> 
                                        <div class="fileUpload blue-btn btn width100">
                        ...
                        <div class="a" id="purchase_consideration">
                    ...
                    <div class="a m-t-20 m-b-20" >
                            <b>Property Amenities</b></p>
