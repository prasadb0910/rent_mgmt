            ...
            <div id="rootwizard">
                <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist" data-init-reponsive-tabs="dropdownfx">
                    ...
                    <li class="nav-item inprocess">
                        <a class="<?php if($checkstatus=='InProcess') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/purchase/checkstatus/InProcess">IN Process(<?php echo $inprocess; ?>)</a>
                    </li>
                </ul>
                <br>
                            ...
                            <div class="col-md-12">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="all">
                                        ...
                                        <div>
                                            <a href="<?php echo base_url(); ?>index.php/purchase/addnew"><button class="btn btn-default pull-right" type="submit"><i class="fa fa-plus tab-icon"></i> <span>Add Property</span></button></a>
                                        </div>
                                        <br>
                                        <div class="row grid">
                                            ...
                                            <div class=" col-md-6">
                                                <div class="markup">
                                                    <div class="card card-transparent container-fixed-lg bg-white " style="background:#fff;">
                                                        <div class="row">
                                                            <div class=" col-md-4">
                                                                <img src="<?php echo base_url().$property[$i]->p_image; ?>" alt="Paris" class="prop_img m-t-20 m-l-20" style="width:180px">
                                                            </div>
                                                            <div class=" col-md-8">
                                                                ...
                                                                <div class="card-block">
                                                                    <p class=" flat_info m-t-0 m-b-0"><?php echo $property[$i]->p_type . ', ' . $property[$i]->pr_agreement_area . ' ' . $property[$i]->pr_agreement_area . ', ' . $property[$i]->p_status; ?></p>
                                            ...
                                            <div class=" col-md-12">
                                                <div class="card card-transparent container-fixed-lg bg-white " style="background:#fff;">
                                                    <div class="row">
                                                        ...
                                                        <p class=" flat_info m-t-0 m-b-0 pull-left" style="margin-top: 45px;padding-left: 20px;"><?php echo $property[$i]->p_type . ', ' . $property[$i]->pr_agreement_area . ' ' . $property[$i]->pr_agreement_area . ', ' . $property[$i]->p_status; ?></p>
                                                        ...
                                                        <div class="prop_btns">
                                                            ...
                                                            <div class="pull-left" style="margin-top: 40px;padding-left: 20px;">
                                                                <a href="<?php echo base_url(); ?>index.php/Allocation" data-toggle="tooltip" data-placement="bottom" title="Maintenance"><i style="font-size:22px;" class="fa fa-file-text-o"></i></a>
                                                            </div>
                                                        </div>
                                                        <a href="<?php echo base_url().'index.php/Purchase/view/'.$property[$i]->txn_id; ?>" class=" pull-left invoice" style="color:#5cb85c;margin-top: 37px;padding-left: 30px;">View <i class="   fa fa-angle-right tab-icon"></i> </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php } ?>
