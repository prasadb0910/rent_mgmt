										...
										if(isset($property_details['schedule_detail'])){
											foreach ($property_details['schedule_detail'] as $row) {
												...
												if($bl_other_schedue=="true") {
													...
													echo '<td>
															<div class="form-group form-group-default ">
																<input type="text" name="basic_amount[]" class="form-control" id="basic_amount_'.($i+1).'" value="'.format_money($property_details['schedule_detail'][$i]['basic_amount'],2).'" onChange="format_number(this); setTotalAmount(this);">
															</div>
														</td>';

													echo '<td>
														<div class="form-group form-group-default">
															<input type="text" id="gst_rate_'.($i+1).'" name="gst_rate[]" class="form-control" style="border: none; text-align:right;" value="'.$property_details['schedule_detail'][$i]['gst_rate'].'" onChange="format_number(this); setTotalAmount(this); getTotOutstanding();" />
														</div>
													</td>';
												} else {
													echo '<td>
											...
											echo '<td>
														<div class="form-group form-group-default ">
															<input type="text" name="basic_amount[]" id="basic_amount_'.($i+1).'" class="form-control" value="" onChange="format_number(this); setTotalAmount(this);">
														</div>
													</td>';
