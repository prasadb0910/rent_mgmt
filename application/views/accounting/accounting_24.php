										...
										<div class="col-md-12">
											<table id="example5" class="table table-bordered table-striped">
												...
												<tbody>
													...
													<?php $j=0; for ($i=0; $i < count($bankentry) ; $i++) { if($bankentry[$i]['particulars']=='Rent' || $bankentry[$i]['particulars']=='Sale' || $bankentry[$i]['particulars']=='Income' || $bankentry[$i]['table_type']=='receipt') { ?>
													<tr class="">
														...
														<?php $duedate =  ($bankentry[$i]['due_date']!=null && $bankentry[$i]['due_date']!='')?date('Y-m-d 00:00:00',strtotime($bankentry[$i]['due_date'])):''; ?>
														<td style="text-align:right" data-order="<?=$duedate?>"><span style="display: none"><?=$duedate?></span><?php echo ($bankentry[$i]['due_date']!=null && $bankentry[$i]['due_date']!='')?date('d/m/Y',strtotime($bankentry[$i]['due_date'])):''; ?></td>
													...
													<?php $j++; }} ?>
													<?php for($i=0;$i<count($pendingbankentry);$i++) { if($pendingbankentry[$i]['particulars']=='Rent' || $pendingbankentry[$i]['particulars']=='Sale' || $pendingbankentry[$i]['particulars']=='Income' || $pendingbankentry[$i]['table_type']=='receipt') { ?>
													<tr class="">
														...
														<td class="acc_dtl">
															...
															<a id="details_<?php echo $j; ?>" onclick="get_details(this);" data-target="#modalSlideLeft" data-toggle="modal">Details</a>
														</td><?php $duedate =  ($pendingbankentry[$i]['due_date']!=null && $pendingbankentry[$i]['due_date']!='')?date('Y-m-d 00:00:00',strtotime($pendingbankentry[$i]['due_date'])):''; ?>
														<td style="text-align:right" data-order="<?=$duedate?>">
															<span style="display: none"><?=$duedate?></span><?php echo ($pendingbankentry[$i]['due_date']!=null && $pendingbankentry[$i]['due_date']!='')?date('d/m/Y',strtotime($pendingbankentry[$i]['due_date'])):''; ?></td>
										...
										<div class="col-md-12">
											<table id="example6" class="table table-bordered table-striped">
												...
												<tbody>
													...
													<?php for ($i=0; $i < count($bankentry) ; $i++) { if($bankentry[$i]['particulars']=='Purchase' || $bankentry[$i]['particulars']=='Loan' || $bankentry[$i]['particulars']=='Expense' || $bankentry[$i]['particulars']=='Maintenance' || $bankentry[$i]['table_type']=='payment') { ?>
													<tr class="">
														<td><span class="btn btn-success paid" >Paid</span></td>
														<td class="acc_dtl">
															<input type="hidden" id="type_<?php echo $j; ?>" value="View" />
													...
													<?php $j++; }} ?>
													<?php for($i=0;$i<count($pendingbankentry);$i++) { if($pendingbankentry[$i]['particulars']=='Purchase' || $pendingbankentry[$i]['particulars']=='Loan' || $pendingbankentry[$i]['particulars']=='Expense' || $pendingbankentry[$i]['particulars']=='Maintenance' || $pendingbankentry[$i]['table_type']=='payment') { ?>
													<tr class="">
														<td><span class="btn btn-danger unpaid" >Unpaid</span></td>
														<td class="acc_dtl">
														...
														<?php $duedate =  ($pendingbankentry[$i]['due_date']!=null && $pendingbankentry[$i]['due_date']!='')?date('Y-m-d 00:00:00',strtotime($pendingbankentry[$i]['due_date'])):''; ?>
														<td style="text-align:right" data-order="<?=$duedate?>">
															<span style="display: none"><?=$duedate?></span><?php echo ($pendingbankentry[$i]['due_date']!=null && $pendingbankentry[$i]['due_date']!='')?date('d/m/Y',strtotime($pendingbankentry[$i]['due_date'])):''; ?></td>
														<td><?php echo $pendingbankentry[$i]['particulars']; ?></td>
														<td><?php if(isset($pendingbankentry[$i]['payer_name'])) echo $pendingbankentry[$i]['payer_name']; ?></td>
