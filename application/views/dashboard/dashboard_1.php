			...
			<div class="m-panel__body">
				...
				<div class=" col-md-6">
						<div class="started start-property">
							...
							<div class="body">
								<a  title="add property &amp; units" href="/property">
				...
				<div class=" col-md-6">
						<div class="started start-tenants">
							...
							<div class="body tenants">
								<a  title="add tenants" href="/users/tenants?status=0">
						...
						<div class="started start-move-in">
							...
							<div class="body move_tenant">
								<!----><a  title="move in a tenant" href="/property/69000/units/139383/leases/add">
					...
					<div class=" col-md-6">
						<div class="started start-free-website">
							...
							<div class="body website">
								<a  title="set up free website" href="/settings/website/edit">
					...
					<div class=" col-md-6">
						<div class="started start-invoice_settings">
							

							<div class="body invoice_settings">
								<a  title="Review invoice settings" href="/settings/payments">
									<span>Review invoice settings</span>
								</a>
								<small>add invoice format and invoice no for accouting</small>
							</div>
						</div>
					</div>
					</div>
