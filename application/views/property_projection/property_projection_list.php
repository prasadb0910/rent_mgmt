        ...
        <div class="page-container page-navigation-top">            
            ...
            <div class="page-content1 page-overflow wrapper wrapper__minify" style="height:auto!important;">
                ...
                <?php $this->load->view('templates/menus');?>
                   <div class="heading-h2"><a href="<?php echo base_url().'index.php/dashboard'; ?>" >  Dashboard  </a> &nbsp; &#10095; &nbsp; Property Valuation List</div>
							  ...
							  <div class="u-borderBottom u-bgColorBreadcrumb ng-scope">
								 <div class="container u-posRelative u-textRight">
									   <div class="pull-left btn-top">
										    	...
										    	<a class="btn btn-default" href="<?php echo base_url().'index.php/property_projection/addnew'; ?>">
																<span class="fa fa-plus"> </span> Add Property Valuation Details
															</a>
														<?php } } ?>
												</div>
									...
									<ul class="m-nav--linetriangle" ng-swipe-left="app.onInnerSwipe($event);" ng-swipe-right="app.onInnerSwipe($event);">
								     <li class="all">
											<a  href="<?php echo base_url(); ?>index.php/property_projection/checkstatus/All">
										...
										<li class="approved" >
											<a  href="<?php echo base_url(); ?>index.php/property_projection/checkstatus/Approved">
                                         ...
                                         <li class="pending">
											<a  href="<?php echo base_url(); ?>index.php/property_projection/checkstatus/Pending">
										...
										<li class="rejected">
											<a href="<?php echo base_url(); ?>index.php/property_projection/checkstatus/Rejected">
										...
										<li class="inprocess">
											<a  href="<?php echo base_url(); ?>index.php/property_projection/checkstatus/InProcess">
								...
								<table id="customers2" class="table datatable table-bordered" style="border-top: none;">
									<thead>
										<tr>
											...
											<th width="55">RRR</th>
											<th width="40">RRV</th>
											<th width="120">Cost Of Aquasition (In Rs)</th>
											<th width="100">Market Rate (In Rs)</th>
											<th width="100">Market Value (In Rs)</th>
											<th width="55">Tax (%)</th>
											<th width="90">Profit / Loss (In Rs)</th>
											<th width="75">Valuation Date</th>
											<th width="50">Status</th>
											</tr>
									</thead>
									<tbody>
										<?php $i=1;
										if(isset($prt_details)){
											foreach($prt_details as $row){
												echo '<tr>
												<td  align="center">'.$i.'</td>
												<td><a href="'.base_url().'index.php/property_projection/view/'.$row->id.'">'.$row->p_property_name.'</a></td>
												<td>'.format_money($row->req_rate_return,2).'</td>
												<td>'.format_money($row->rrv_value,2).'</td>
												<td>'.format_money($row->cost_of_aqua,2).'</td>
												<td>'.format_money($row->market_rate,2).'</td>
												<td>'.format_money($row->market_value,2).'</td>
												<td>'.$row->tax_name.'</td>
												<td>'.format_money($row->profit_loss,2).'</td>
												<td>'.(($row->projection_date!=null && $row->projection_date!='')?date('d/m/Y',strtotime($row->projection_date)):'').'</td>
												<td>'.$row->status.'</td>
												</tr>';
												$i++;
										} ?>
