					                ...
					                <!-- <div class="row push-up-10" <?php //if(isset($rep_grp_4)) {if($rep_grp_4==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>>
										<div class="col-md-4">
					                        ...
					                        <div class="panel panel-success">
					                            ...
					                            <label class="list-group-item-reports" <?php //if(isset($rep_16_view)) {if($rep_16_view==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><input type="checkbox" id="group4_a" name="report[]" value="16" <?php //if(isset($rep_16)) {if($rep_16==1) echo 'checked';} ?> />  Accounting Policies  </label>
					                            <label class="list-group-item-reports" <?php //if(isset($rep_17_view)) {if($rep_17_view==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><input type="checkbox" id="group4_b" name="report[]" value="17" <?php //if(isset($rep_17)) {if($rep_17==1) echo 'checked';} ?> /> Depreciation Accounting   </label>
					                            <label class="list-group-item-reports" <?php //if(isset($rep_18_view)) {if($rep_18_view==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><input type="checkbox" id="group4_c" name="report[]" value="18" <?php //if(isset($rep_18)) {if($rep_18==1) echo 'checked';} ?> />  Accounting for Leases   </label>
					                            <label class="list-group-item-reports" <?php //if(isset($rep_19_view)) {if($rep_19_view==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><input type="checkbox" id="group4_d" name="report[]" value="19" <?php //if(isset($rep_19)) {if($rep_19==1) echo 'checked';} ?> />  Earnings per Share  </label>
					                            <label class="list-group-item-reports" <?php //if(isset($rep_20_view)) {if($rep_20_view==0) echo 'style="display: none;"';} else echo 'style="display: none;"'; ?>><input type="checkbox" id="group4_e" name="report[]" value="20" <?php //if(isset($rep_20)) {if($rep_20==1) echo 'checked';} ?> />  Financial Instruments  </label>
					                            </div>
					                        </div>
					                    </div>
