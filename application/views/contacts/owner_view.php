									...
									<div class="a">
										<div class="row clearfix">
											<div class="col-md-6">
												...
												<div class="form-group form-group-default">
													...
													<input type="text" class="form-control" name="company_name"value="<?php if(isset($editcontact)) { echo  $editcontact[0]->c_company_name; } ?>" readonly/>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group form-group-default ">
													<label>Registration No</label>
													<input type="text" class="form-control" name="reg_no" value="<?php if(isset($editcontact)) { echo  $editcontact[0]->c_reg_no; } ?>" readonly/>
												</div>
											</div>
										</div>
										<div class="row clearfix">
											<div class="col-md-6">
												<div class="form-group form-group-default">
													...
													<input type="text" class="form-control" name="incop_date"  value="<?php if(isset($editcontact)) { if($editcontact[0]->c_incop_date!='' && $editcontact[0]->c_incop_date!=null) echo date('d/m/Y', strtotime($editcontact[0]->c_incop_date)); } ?>" readonly/>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group form-group-default form-group-default-select2">
													<label>Contact Person</label>
													<select id="c_contact_id" name="contact_id" class="form-control full-width"  data-init-plugin="select2" data-error="#contact_id_error" disabled>
										...
										<div class="row clearfix">
											...
											<div class="col-md-6">
												<div class="form-group form-group-default">
													<label>Pincode </label>
													<input type="text" class="form-control" name="pincode" id="pincode" value="<?php if(isset($editcontact)) { echo  $editcontact[0]->c_pincode; } ?>" readonly/>
												</div>
											</div>
										</div>
										<div class="row clearfix">
										...
										<div class="row clearfix">
											<div class="col-md-6">
												<div class="form-group form-group-default">
													...
													<input type="text" class="form-control" name="branch_address"  value="<?php if(isset($editcontact)) { echo  $editcontact[0]->c_branch; } ?>" readonly/>
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group form-group-default">
													<label>Telephone No.</label>
													<input type="text" class="form-control" name="telephone_number"  value="<?php if(isset($editcontact)) { echo  $editcontact[0]->c_telephone; } ?>" readonly/>
												</div>
											</div>
										</div>
										<div class="row clearfix">
											<div class="col-md-6">
												<div class="form-group form-group-default">
													...
													<input type="text" class="form-control" name="mob_number" value="<?php if(isset($editcontact)) { echo  $editcontact[0]->c_mobile; } ?>" readonly/>
												</div>
											</div>
		                                    ...
		                                    <div id="repeat_contact_person_<?php echo $l+1; ?>" class="row clearfix">
		                                        <div class="col-md-4">
		                                        	<div class="form-group form-group-default form-group-default-select2 required">
														...
														<select id="contact_person_id_<?php echo $l; ?>" name="contact_person_id[]" class="form-control full-width contact_person" data-placeholder="Select" data-init-plugin="select2" data-error="#contact_person_id_<?php echo $l; ?>_error" disabled>
			                                                <option value="">Select</option>
			                                                <?php for ($k=0; $k < count($contact) ; $k++) { ?>
			                                                    <option value="<?php echo $contact[$k]->c_id; ?>" <?php if(isset($editcontperson)) { if($contact[$k]->c_id==$editcontperson[0]->c_id) { echo 'selected'; } } ?>><?php echo $contact[$k]->contact_name; ?></option>
			                                                <?php } ?>
			                                            </select>
