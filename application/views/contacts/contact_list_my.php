        ...
        <div class=" container-fluid container-fixed-lg">
            ...
            <div id="rootwizard">
                <ul class="nav nav-tabs nav-tabs-linetriangle nav-tabs-separator nav-stack-sm" role="tablist" data-init-reponsive-tabs="dropdownfx">
                    <li class="nav-item">
                        <a class="<?php if($contact_type=='Tenants') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/contacts/checkstatus/All/All"><i class="fa fa-shopping-cart tab-icon"></i> <span>TENANTS</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="<?php if($contact_type=='Owners') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/contacts/checkstatus/Owners/All"><i class="fa fa-truck tab-icon"></i> <span>OWNERS</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="<?php if($contact_type=='Others') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/contacts/checkstatus/Others/All"><i class="fa fa-credit-card tab-icon"></i> <span>Others</span></a>
                    </li>
                </ul>
                <br>
                            ...
                            <div class="col-md-12"> 
                                <ul class="nav nav-tabs nav-tabs-simple" role="tablist" data-init-reponsive-tabs="dropdownfx">
                                    <li class="nav-item all">
                                        <a class="<?php if($checkstatus=='All') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/contacts/checkstatus/<?php echo $contact_type; ?>/All">All(<?php echo count($all); ?>)</a>
                                    </li>
                                    <li class="nav-item approved">
                                        <a class="<?php if($checkstatus=='Approved') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/contacts/checkstatus/<?php echo $contact_type; ?>/Approved">Approved(<?php echo count($approved); ?>)</a>
                                    </li>
                                    <li class="nav-item pending">
                                        <a class="<?php if($checkstatus=='Pending') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/contacts/checkstatus/<?php echo $contact_type; ?>/Pending">Pending(<?php echo count($pending); ?>)</a>
                                    </li>
                                    <li class="nav-item rejected">
                                        <a class="<?php if($checkstatus=='Rejected') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/contacts/checkstatus/<?php echo $contact_type; ?>/Rejected">Rejected(<?php echo count($rejected); ?>)</a>
                                    </li>
                                    <li class="nav-item inprocess">
                                        <a class="<?php if($checkstatus=='InProcess') echo 'active'; ?>" href="<?php echo base_url(); ?>index.php/contacts/checkstatus/<?php echo $contact_type; ?>/InProcess">IN Process(<?php echo count($inprocess); ?>)</a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="tab-pane active" id="all">
                                        ...
                                        <div class="form-group form-group-default form-group-default-select2 required " style="max-width:33.33%;float:right ">
                                            ...
                                            <select class="full-width" data-placeholder="Select Country" onchange="location = this.value;" data-init-plugin="select2" name="type" id="type" style="text:align:left;">
                                                ...
                                                <option value="<?php echo base_url(); ?>index.php/contacts/addnew/<?php echo $contact_type; ?>/individual">Individual</option>
                                                <option value="<?php echo base_url(); ?>index.php/contacts/addnew/<?php echo $contact_type; ?>/huf">Huf</option>
                                                <option value="<?php echo base_url(); ?>index.php/contacts/addnew/<?php echo $contact_type; ?>/pvtltd">Private Limited</option>
                                                <option value="<?php echo base_url(); ?>index.php/contacts/addnew/<?php echo $contact_type; ?>/ltd">Limited</option>
                                                <option value="<?php echo base_url(); ?>index.php/contacts/addnew/<?php echo $contact_type; ?>/llp">LLP</option>
                                                <option value="<?php echo base_url(); ?>index.php/contacts/addnew/<?php echo $contact_type; ?>/partnership">Partnership</option>
                                                <option value="<?php echo base_url(); ?>index.php/contacts/addnew/<?php echo $contact_type; ?>/aop">AOP</option>
                                                <option value="<?php echo base_url(); ?>index.php/contacts/addnew/<?php echo $contact_type; ?>/trust">Trust</option>
                                                <option value="<?php echo base_url(); ?>index.php/contacts/addnew/<?php echo $contact_type; ?>/proprietorship">Proprietorship</option>
                                            </select>
                                        </div>
                                        <br>
                                        <div class="row">
                                                    ...
                                                    <div class="card card-transparent container-fixed-lg bg-white contact_card " style="background:#fff;">
                                                        <div class="row">
                                                            <div class=" col-md-12">
                                                                ...
                                                                <span class="badge badge-notify"><i class=" fa fa-comments" style="font-size:16px!important;"></i></span>
                                                                <div class="info">
                                                ...
                                                <div class="card card-transparent container-fixed-lg bg-white contact_card " style="background:#fff;">
                                                    <div class="row">
                                                        <div class=" col-md-12" >
                                                            ...
                                                            <span class="badge badge-notify" style="left: 74px;"><i class=" fa fa-comments" style="font-size:16px!important;"></i></span>
                                                            ...
                                                            <a href="<?php echo base_url().'index.php/Contacts/viewrecord/'.$contacts[$i]->c_id; ?>" class=" pull-right invoice" style="color:#5cb85c;margin-top: 37px;padding-right:50px">View <i class="    fa fa-angle-right tab-icon"></i> </a>
