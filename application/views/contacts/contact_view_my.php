										...
										<div class="a">
											<div class="row clearfix">
												<div class="col-md-4">
													<div class="form-group form-group-default ">
														...
														<input type="text" class="form-control " name="c_name" id="c_name" placeholder="First Name" value="<?php if (isset($editcontact)) { echo $editcontact[0]->c_name; } ?>" readonly>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group form-group-default ">
														<label>Middle Name</label>
														<input type="text" class="form-control " name="c_middle_name" id="c_middle_name" placeholder="Middle Name" value="<?php if (isset($editcontact)) { echo $editcontact[0]->c_middle_name; } ?>" readonly>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group form-group-default ">
														<label>Last Name</label>
														<input type="text" class="form-control " name="c_last_name" id="c_last_name" placeholder="Last Name" value="<?php if (isset($editcontact)) { echo $editcontact[0]->c_last_name; } ?>" readonly>
													</div>
												</div>
											</div>
											<div class="row clearfix">
				                                <div class="col-md-4">
				                                    <div class="form-group form-group-default">
				                                        ...
				                                        <input type="text" class="form-control" id="dob" name="date_of_birth" placeholder="Date Of Birth" value="<?php if (isset($editcontact)) { if($editcontact[0]->c_dob!='' && $editcontact[0]->c_dob!=null) echo date('d/m/Y',strtotime($editcontact[0]->c_dob)); } ?>" readonly>
				                                    </div>
				                                </div>
				                                <div class="col-md-4">
				                                    <div class="form-group form-group-default">
				                                        <label>Anniversary Date</label>
				                                        <input type="text" class="form-control" id="date_of_anniversary" name="date_of_anniversary" placeholder="Date Of Anniversary" value="<?php if (isset($editcontact)) { if($editcontact[0]->c_anniversarydate!='' && $editcontact[0]->c_anniversarydate!=null) echo date('d/m/Y',strtotime($editcontact[0]->c_anniversarydate)); } ?>" readonly>
				                                    </div>
				                                </div>
				                                <div class="col-md-4">
				                                    <div class="form-group form-group-default">
				                                        <label class="">Gender</label>
				                                        <input type="text" class="form-control" name="gender" id="gender" placeholder="Gender" value="<?php if (isset($editcontact)) { echo $editcontact[0]->c_gender; } ?>" readonly>
				                                    </div>
				                                </div>
				                            </div>
				                                ...
				                                <div class="row clearfix">
				                                    <div class="col-md-6">
				                                        <div class="form-group form-group-default form-group-default-select2">
				                                            ...
				                                            <select id="guardian" name="guardian" class="form-control full-width" data-placeholder="Select Guardian" data-init-plugin="select2" disabled="true">
				                                            ...
				                                            <!-- <input type="text" class="form-control " name="guardian" id="guardian" placeholder="Guardian" value="<?php //if (isset($editcontact)) { echo $editcontact[0]->c_guardian; } ?>" readonly> -->
				                                        </div>
				                                    </div>
				                                    <div class="col-md-6">
				                                        <div class="form-group form-group-default">
				                                            <label>Relation</label>
				                                            <input type="text" class="form-control " id="guardian_relation" name="guardian_relation" placeholder="Guardian Relation" value="<?php if (isset($editcontact)) { echo $editcontact[0]->c_relation; } ?>" readonly>
				                                        </div>
				                                    </div>
				                                </div>
				                            </div>
				                            <div class="row clearfix">
				                                <div class="col-md-4">
				                                    <div class="form-group form-group-default">
				                                        ...
				                                        <input type="text" class="form-control " name="designation" id="designation" placeholder="Designation" value="<?php if (isset($editcontact)) { echo $editcontact[0]->c_designation; } ?>" readonly>
				                                    </div>
				                                </div>
				                                <div class="col-md-8">
				                                    <div class="form-group form-group-default">
				                            ...
				                            <div class="row clearfix">
				                                ...
				                                <div class="col-md-4">
				                                    <div class="form-group form-group-default">
				                                        <label>Pincode </label>
				                                        <input type="text" class="form-control " name="pincode" placeholder="Pincode" value="<?php if (isset($editcontact)) { echo $editcontact[0]->c_pincode; } ?>" readonly>
				                                    </div>
				                                </div>
				                            </div>
				                            <div class="row clearfix">
				                                ...
				                                <div class="col-md-4">
				                                    <div class="form-group form-group-default">
				                                        ...
				                                        <input type="text" class="form-control " id="email_id1" name="email_id1" placeholder="Email Id 1" value="<?php if (isset($editcontact)) { echo $editcontact[0]->c_emailid1; } ?>" readonly>
				                                    </div>
				                                </div>
				                            </div>
				                            <div class="row clearfix">
				                                <div class="col-md-4">
				                                    <div class="form-group form-group-default">
				                                        ...
				                                        <input type="text" class="form-control " id="email_id2" name="email_id2" placeholder="Email Id 2" value="<?php if (isset($editcontact)) { echo $editcontact[0]->c_emailid2; } ?>" readonly>
				                                    </div>
				                                </div>
				                                <div class="col-md-4">
				                                    <div class="form-group form-group-default">
				                                        <label>Mobile No - 1 </label>
				                                        <input type="text" class="form-control " id="mobile_no1" name="mobile_no1" placeholder="Mobile No 1" value="<?php if (isset($editcontact)) { echo $editcontact[0]->c_mobile1; } ?>" readonly>
				                                    </div>
				                                </div>
				                                <div class="col-md-4">
				                                    <div class="form-group form-group-default">
				                                        <label>Mobile No - 2 </label>
				                                        <input type="text" class="form-control " id="mobile_no2" name="mobile_no2" placeholder="Mobile No 2" value="<?php if (isset($editcontact)) { echo $editcontact[0]->c_mobile2; } ?>" readonly>
				                                    </div>
				                                </div>
				                            </div>
										</div>
			                                    ...
			                                    <div id="repeat_nominee_<?php echo $j+1; ?>" class="row clearfix">
			                                        ...
			                                        <div class="col-md-4">
			                                            <div class="form-group form-group-default form-group-default-select2">
			                                                ...
			                                                <select id="nm_name_<?php echo $j+1; ?>" name="nm_name[]" class="form-control nm_name full-width" data-placeholder="Select Contact" data-init-plugin="select2" disabled="true">
			                                                    <option value="">Select</option>
			                                                    <?php for ($k=0; $k < count($contact) ; $k++) { ?>
			                                        ...
			                                        <div class="col-md-4">
			                                            <div class="form-group form-group-default">
			                                                <label>Relation</label>
			                                                <input type="text" name="nm_relation[]" class="form-control" placeholder="Relation" value="<?php if(isset($editcontnom[$j]->relation)){ echo $editcontnom[$j]->relation; } else { echo ''; }?>" readonly/>
			                                            </div>
			                                        </div>
			                                    </div>
