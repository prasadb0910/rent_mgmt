...
<li class="breadcrumb-item active"><a href="#">TASK View</a></li>
...
<label>Subject </label>
<input type="text" class="form-control "  value="1" name="subject_detail" id="Organisation Name" readonly>
</div>
</div>
</div>
...
<input type="text" class="form-control "  value="1" name="description" id="Registration No" readonly>
</div>
</div>
</div>
...
<div class="form-group form-group-default ">
<label>Status</label>
<input type="text" class="form-control "  value="Pending " id="status" readonly>
</div>
</div>
...
<input type="text" class="form-control "  value="low " id="status" readonly>
</div>
</div>
...
<input  type="text" class="form-control " value="9/01/2018 4.56pm" name="dob" readonly >
</div>
</div>
...
<div class="form-group form-group-default ">
<label>To Date</label>
<input  type="text" class="form-control " value="29/01/2018 4.56pm" name="dob" readonly >
</div>
</div>
...
<div class="form-group form-group-default ">
<label>Owner</label>
<input type="text" class="form-control " value="prasad" name="owner_name" readonly>
</div>
</div>
<div class="col-md-6">
...
<input type="text" class="form-control " value="daily" name="Frequency" readonly>
</div>
</div>
...
<input type="text" class="form-control " value="self" name="assign_to" readonly>
</div>
</div>
...
<div class="form-group form-group-default ">
<label>Assign To</label>
<input type="text" class="form-control " value="Prasad prasadb0910@gmail.com 9632587410" name="assign_to" readonly>
</div>
...
<div class="col-md-6">
<div class="form-group form-group-default ">
<label>Task Follower</label>
<input type="text" class="form-control " value="Prasad prasadb0910@gmail.com 9632587410" name="follower" readonly>
</div>
...
<button class="btn btn-default pull-left"  type="submit">Comment</button>
<button class="btn btn-default-danger pull-right"  type="submit">Delete</button>
<button class="btn btn-default pull-right m-r-10" type="submit">Complete</button>
