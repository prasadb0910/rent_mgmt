...
<link href="assets/css/accounting.css" rel="stylesheet" type="text/css" media="screen">
...
<div class="card card-transparent container-fixed-lg bg-white contact_card m-t-30" id="pricing_box"style="background:#a5b1de;">

<div class="row" style="padding-left:15px;padding-right:15px;">
<div class="col-md-6 rent">
<a href="receive_payment.php"><i style="font-size:22px;" class="fa fa-th-list"></i><br>
Receive</a>
</div>

<div class="col-md-6 rent" style="border-right:none;">
<a href="pay.php"><i style="font-size:22px;" class="fa fa-money"></i><br>
Pay</a>
</div>
<div class=" col-md-6 leases">
<a href="add_income.php"><i style="font-size:22px;" class="fa fa-plus-square"></i><br>
Add Income</a>
</div>
<div class=" col-md-6 leases" style="border-right:none;">
<a href="add_expense.php"><i style="font-size:22px;" class="fa fa-plus-square "></i><br>
Add Expense</a>

</div>
<div class=" col-md-6 leases">
<a href="#"><i style="font-size:22px;" class="fa fa-rupee"></i><br>
Manage GST</a>

</div>
<div class=" col-md-6 leases" style="border-right:none;">
<a href="manage_tds.php"><i style="font-size:22px;" class="fa fa-rupee"></i><br>
Manage TDS</a>
...
<div class="col-md-12">
<div class=" container-fluid  container-fixed-lg bg-white p-b-10 p-t-20">
<div class="row clearfix" >
<div class="col-md-4">
...
<thead>
<tr class="p-receipts">
<td  colspan="11" >Pending Receipts</td>
...
<td>20,000</td>
<td>500</td>
<td class="acc_dtl"> <a data-target="#modalSlideLeft" data-toggle="modal">Details ></a></td>
...
<tr class="">
<td>
<span class="btn btn-danger unpaid" >Unpaid</span></td>
<td>05-01-2018</td>
<td>Rent</td>
<td>Raj Shah</td>
<td>Green Acres	</td>
...
<td style="display:none"></td>
<td style="display:none"></td>
<td style="background-color:#f6f9fc!important;">40,000</td>
<td style="background-color:#f6f9fc!important;">0</td>
<td style="background-color:#f6f9fc!important;">20,000</td>
<td style="background-color:#f6f9fc!important;"> 100</td>
<td style="background-color:#f6f9fc!important;"></td>
...
<thead>
<tr class="p-receipts">
<td  colspan="11" >Pending Payments</td>
<td style="display:none"></td>
<td style="display:none"></td>
<td style="display:none"></td>
<td style="display:none"></td>
...
<div class="header-nav " style="">
							<div class="m-status--payment-status status-0 pull-left">
								unpaid
							</div>
						
							<div class="nav-btn p-l-10 p-r-10">
						<a class="btn btn-success pull-left ">Receive payment</span>
	...
	<!----><div class="info-location p-b-10" >
		...
		<div class="footer-detail pull-left p-r-10">
			...
			<div class="info-date" >
				<div class="date">Updated 27/01/2018</div>
			</div>
		</div> &nbsp 
