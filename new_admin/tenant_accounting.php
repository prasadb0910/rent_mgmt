...
<link class="main-stylesheet" href="assets/css/accounting.css" rel="stylesheet" type="text/css" />
...
<li class="breadcrumb-item"><a href="ass">Lease List</a></li>
...
<div class="bg-master text-center text-white" style=" background: #41c997;text-align: center; -size:28pxalign-items:center;text-align: center;padding-top: 17px;font-size:24px;"><span>DM</span>
</div>  
...
<div class=" col-md-12">
<span class="invoice"><a href="input_form.html"><button class="btn btn-success  btn-xs invoice" type="submit"><span>Tenant Statement	
	</span></button></a></span>
...
<div class="col-md-9">
<div class="row clearfix" style="background-image: linear-gradient(135deg, #5f77df 0%, #7489e3 100%);margin-left:0px!important;margin-right:0px!important;">
<div class="col-md-6">
<div class="rent-block" style="border-right:2px solid #fff">

<h2 class="category">Total Deposits</h2>
<span class="total"> Rs. 50,000</span><br>
<span class="btn btn-link1">Return</span>
...
<h2 class="category">Total Overdue</h2>
<span class="total"> Rs. 10,000</span>
</div>
</div>
</div>
...
<tr class="odd_cell" >
<td colspan="11" style="background-color:#f6f9fc!important;">Feb, 2018</td>
<td style="display:none"></td>
<td style="display:none"></td>
<td style="display:none"></td>
<td style="display:none"></td>
