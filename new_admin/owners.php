...
<li class="breadcrumb-item active"><a href="#">Owner List</a></li>
...
<select class="full-width" data-placeholder="Select Country" onchange="location = this.value;" data-init-plugin="select2" name="type" id="type">
...
<i style="font-size:22px;" class="fa fa-tags"></i><br>
Individual
</div>

<div class=" col-md-6 leases">
<i style="font-size:22px;" class="fa fa-calendar "></i><br>
5/12/2017
</div>
...
<a href="owner_individual_view.php" class=" pull-right invoice" style="color:#5cb85c;">View <i class="	fa fa-angle-right tab-icon"></i> </a>
</div>
</div>
