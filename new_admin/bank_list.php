...
<li class="breadcrumb-item active"><a href="#">Accounting</a></li>
...
<li class="nav-item">
<a class="active" data-toggle="tab" href="#tab1" role="tab"><i class="fa fa-shopping-cart tab-icon"></i> <span>Bank</span></a>
</li>
<li class="nav-item">
<a class="" data-toggle="tab" href="#tab2" role="tab"><i class="fa fa-truck tab-icon"></i> <span>Accounting Category</span></a>
</li>
...
<div class="row">
<div class=" col-md-12" >
<a href="bank_details.php"><button class="btn btn-default pull-right" type="submit"><i class="fa fa-plus tab-icon"></i> <span>Add Bank Deatails</span></button></a></div>
<br>
...
<div class="info">
<H5 class="title_1">HDFC Bank</H5>
<p class="email">Dhawal Maru </p>
...
<div class=" col-md-12">
<span class="invoice"><a href=""><button class="btn btn-success pull-left btn-xs invoice" type="submit"><span>Approved </span></button></a></span>
<a href="bank_view.php" class=" pull-right invoice" style="color:#5cb85c;">View <i class="	fa fa-angle-right tab-icon"></i> </a>
</div>
</div>
