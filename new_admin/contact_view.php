...
<input type="text" class="form-control" name="document_type." value="aa" readonly>
</div></div>
<div class="col-md-4">
<div class="form-group form-group-default ">
<label>Description</label>
<input type="text" class="form-control" name="Description." value="aa" readonly>
</div></div>
<div class="col-md-4"><div class="form-group form-group-default ">
<label>Refernce No.</label>
<input type="text" class="form-control" name="Refernce No." value="aa" readonly>
</div></div></div>
<div class="row clearfix">
<div class="col-md-4">
<div class="form-group form-group-default ">
<label>Date Of Issue</label>
<input type="text" class="form-control" name="DOI." value="aa" readonly>
</div></div>
<div class="col-md-4">
<div class="form-group form-group-default ">
<label>Date Of Expiry</label>
<input type="text" class="form-control" name="DOE." value="aa" readonly>
</div></div></div>
<div class="row clearfix"> 
