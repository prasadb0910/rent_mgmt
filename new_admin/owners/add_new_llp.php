...
<input type="text" class="form-control " name="HUF Name" id="HUF Name" required>
</div>
</div>
<div class="col-md-6">
<div class="form-group form-group-default required">
...
<input id="dob" type="text" class="form-control date" name="Date of Incorp " required>
</div>
</div>
...
<div class="optionBox" id="optionBox">
    ...
    <div class="block" id="block">
        <span class="add" id="add">+ Add Family Details.</span>
    </div>
</div>
</div>
...
<button class="btn btn-default" style="float:right;" type="submit"> submit</button>
