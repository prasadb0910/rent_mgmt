...
<li class="breadcrumb-item "><a href="sale_list.php">Sale List</a></li>
...
<input id="date_of_sale" type="text" class="form-control date" name="date_of_sale " >
</div>
</div>
...
<div class="optionBox" id="buyer_box">
  
    <div class="block" id="buyer_block">
        <span class="add" id="add_buyer">+ Add Buyer Details</span>
    </div>
</div>
</div>
