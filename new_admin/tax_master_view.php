...
<li class="breadcrumb-item"><a href="tax_master_list.php">Tax List</a></li>
<li class="breadcrumb-item active"><a href="#"> TAX VIEW</a></li>
...
<input type="text" class="form-control "  name="" value="tax_name" name="" id="" readonly>
</div>
</div>
...
<input type="text" class="form-control " name="tax_perecnt" value="tax_perecnt" name="" id="" readonly>
</div>
</div>
...
<input type="text" class="form-control " name="" value="1" name="txn_for_1" id="" readonly>
</div>
</div>
<div class="col-md-6">
<div class="form-group form-group-default ">
<label>Transaction Action</label>
<input type="text" class="form-control " name="txn_type_1" value="1" name="" id="" readonly>
</div>
</div>
</div>
...
<input type="text" class="form-control "name="" value="1" name="effective_date_1" id="" readonly>
</div>
</div>
</div>
</div>
...
<a href="tax_master_list.php" class="btn btn-default-danger pull-right" >Cancel</a>
