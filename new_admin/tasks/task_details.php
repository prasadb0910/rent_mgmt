...
<li class="breadcrumb-item "><a href="task_list.php">Task List</a></li>
...
</div><span><a href="#" class="delete_img"><i class=" fa fa-trash pull-right" style="color:#d63b3b;font-size:18px;"></i></a></span></div>
...
<label>Subject </label>
<input type="text" class="form-control " name="subject_detail" id="Organisation Name" required>
</div>
</div>
</div>
<div class="row clearfix">
...
<input type="text" class="form-control " name="description" id="Registration No" required>
</div>
</div>
</div>
...
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2" name="task_status">
...
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2" name="priority">
...
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2" name="sub_property">
<option value="select">select</option>
...
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2" name="repeat" id="repeat">
...
<div class="row clearfix" id="repeat-periodically">
<div class="col-md-6">

<div class="form-group form-group-default form-group-default-select2 required" >
<label class="">Interval after</label>
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2" name="periodic_interval">
<option value="Never">Select</option>
<?php for($i=1;$i<=30;$i++){?>

<option value="Never"><?php echo $i ;?></option><?php }?>
...
<div class="row clearfix" id="repeat-weekly">
<div class="col-md-2">
...
<label for="checkbox1">Mon</label> &nbsp


<input type="checkbox" checked="checked" value="1" id="checkbox2">
<label for="checkbox2">Tue</label> &nbsp


<input type="checkbox" value="1" id="checkbox3">
<label for="checkbox3">Wed</label> &nbsp


<input type="checkbox" value="1" id="checkbox4">
<label for="checkbox4">Thu</label> &nbsp


<input type="checkbox" checked="checked" value="1" id="checkbox5">
<label for="checkbox5">Fri</label> &nbsp

<input type="checkbox" checked="checked" value="1" id="checkbox6">
<label for="checkbox6">Sat</label> &nbsp


<input type="checkbox"  value="1" id="checkbox7">
<label for="checkbox7">Sun</label>

</div>
</div>


<div class="row clearfix" id="repeat-monthly">
<div class="col-md-6">

<div class="form-group form-group-default form-group-default-select2 required" >
<label class="">Every Month ON</label>
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2" name="repeat">
<option value="Never">Select</option>
<?php for($i=1;$i<=12;$i++){?>
...
<div class="form-group form-group-default form-group-default-select2 required" >
<label class=""> Day Of The Month</label>
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2" name="repeat">
<option value="Never">Select</option>
<?php for($i=1;$i<=30;$i++){?>
...
<div class="a" id="assign">
<p class="m-t-20"><b>Assign To<b></p>
...
<div class="optionBox" id="assign_box">
  
    <div class="block" id="assign_block">
        <span class="add" id="add_assign">+ Add Assign details</span>
    </div>
</div>
</div>
...
<div class="a" id="follower_div">
<p class="m-t-20"><b>Task Follower<b></p>
...
<div class="optionBox" id="follower_box">
  
    <div class="block" id="follower_block">
        <span class="add" id="add_follower">+ Add Task Follower</span>
    </div>
</div>
</div>
