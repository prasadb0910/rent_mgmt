...
<li class="breadcrumb-item "><a href="property_projection_list.php"> PROPERTY VALUATION LIST</a></li>
<li class="breadcrumb-item active"> PROPERTY VALUATION DETAILS</li>
</ol>
<div class="row">
<div class="col-md-4">
...
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2" id="property" name="property">
...
<label>RRR </label>
<input type="text" class="form-control " name="req_rate_return" id="req_rate_return">
</div>
</div>
...
<div class="form-group form-group-default required">
<label>RRV</label>
<input type="text" class="form-control " name="rrv_value" id="rrv_value">
</div>
...
<div class="col-md-6">
<div class="form-group form-group-default required">
<label>Index Cost Value </label>
<input type="text" class="form-control " name="index_cost_value" id="index_cost_value">
</div>
...
<label>Date</label>
<input id="Date of Incorp" type="text" class="form-control date" name="projection_date"  id="projection_date">
</div>
</div>
...
<input type="text" class="form-control " name="market_rate" id="market_rate" required>
</div>
</div>
<div class="col-md-6">
<div class="form-group form-group-default required">
...
<div class="col-md-6">
<div class="form-group form-group-default form-group-default-select2 required">
<label class="">Tax Applicable </label>
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2" id="tax_app" name="tax_app">
<option value="Select">Select</option>
...
<input type="text" class="form-control " name="maker_remark" id="maker_remark">
</div>
</div>
</div>
