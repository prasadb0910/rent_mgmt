...
<li class="breadcrumb-item "><a href="purchase_list.php">Purchase LIST</a></li>
<li class="breadcrumb-item active"><a href="#"> Purchase VIEW</a></li>
...
<a href="sale_list.php"><div class="fileUpload blue-btn btn width100 pull-left">
...
<p class="created_date">Created on 05/01/20</p>
...
<input type="text" class="form-control " name="Property Name" value="aa" readonly>
</div>
</div>
...
<input type="text" class="form-control" name="Display Name" value="aa" readonly>
</div>
</div>
...
<input  type="text" class="form-control " name="Date Of Purchase" value="aa" readonly>
</div>
</div>
...
<input  type="text" class="form-control " name="aaa" value="aa" readonly>
</div>
</div>
<div class="col-md-6">
<div class="form-group form-group-default  ">
...
<input type="text" class="form-control " name="Property Description" id="Property Description" value="aa" readonly >
</div>
</div>
</div>
</div>
...
<input type="text" class="form-control " name="Building Name" value="aa" readonly>
</div>
</div>
<div class="col-md-6">
<div class="form-group form-group-default ">
<label>Unit No</label>
<input type="text" class="form-control " name="Unit No" value="aa" readonly>
</div>
</div>
...
<div class="form-group form-group-default ">
<label>Floor</label>
<input type="text" class="form-control " name="Floor" value="aa" readonly >
</div>
</div>
<div class="col-md-6">
<div class="form-group form-group-default ">
<label>Wing</label>
<input type="text" class="form-control " name="Wing" value="aa" readonly>
</div>
</div>
...
<div class="form-group form-group-default ">
<label>Address</label>
<input type="text" class="form-control " name="Address" value="aa" readonly>
</div>
</div>
<div class="col-md-6">
<div class="form-group form-group-default ">
<label>Landmark </label>
<input type="text" class="form-control " name="landmark" value="aa" readonly>
</div>
</div>
</div>
...
<div class="form-group form-group-default ">
<label>City </label>
<input type="text" class="form-control " name="endDate" value="aa" readonly>
</div>
</div>
...
<div class="form-group form-group-default ">
<label>State</label>
<input type="text" class="form-control " name="startDate" value="aa" readonly >
</div>
</div>
<div class="col-md-6">
<div class="form-group form-group-default ">
...
<input type="text" class="form-control " name="Agreement Area"  value="aa" readonly>
</div>
</div>
...
<input type="text" class="form-control " name="Land Area" value="aa" readonly>
</div>
</div>
...
<input type="text" class="form-control " name="Carpet Area" value="aa" readonly>
</div>
</div>
</div>
...
<input type="text" class="form-control " name="Built Up Area" value="aa" readonly>
</div>
</div>
...
<input type="text" class="form-control " name="Saleable Area" value="aa" readonly>
</div>
</div>
...
<input type="text" class="form-control " name="Bunglow  Area" value="aa" readonly>
</div>
</div>
...
<input type="text" class="form-control " name="No Of Floors" value="aa" readonly>
</div>
</div>
<div class="col-md-4">
<div class="form-group form-group-default ">
<label>No Of Flats</label>
<input type="text" class="form-control " name="No Of Flats" value="aa" readonly>
</div>
</div>
...
<input type="text" class="form-control " name="No Of Shops" value="aa" readonly>
</div>
</div>
...
<input type="text" class="form-control " name="No Of Open Parking" value="aa" readonly>
</div>
</div>
...
<tr class="odd gradeX">
<td colspan="2">Grand Total (in ₹)</td>
