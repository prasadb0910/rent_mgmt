...
<li class="breadcrumb-item active">Owner Details -AOP</li>
</ol>
<div class="row">
<div class="col-md-4">
...
<div class="optionBox" id="partner_box">
  
    <div class="block" id="partner_block">
        <span class="add" id="add_partner">+ Add Partnership Details</span>
    </div>
</div>
</div>
