...
<span><b> Owner Level Sale Details Report<b><button class="btn btn-default-danger pull-right"  type="submit"><i class="fa fa-file-pdf-o "></i> View Sample</button></span>
<br>
...
<option value="AK">Select Owner</option>
</select>
</div>
</div>
...
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2">
<option value="AK">Select Property</option>
...
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2">
<option value="AK">Select Sub Property</option>
...
<label>From </label>
<input id="from_date" type="text" class="form-control date" name="from_date " >
</div>
</div>
...
<div class="form-group form-group-default required">
<label>To</label>
<input id="to_date" type="text" class="form-control date" name="to_date " >
</div>
</div>
