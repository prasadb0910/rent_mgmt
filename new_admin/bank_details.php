...
<label>Owner </label>
<input type="text" class="form-control " name="Organisation Name" id="Organisation Name" >
</div>
</div>
<div class="col-md-6">
...
<div class="a">
<p class="m-t-20"><b>Bank Details<b></p>
<div class="row clearfix">
...
<input type="text" class="form-control " name="Bank Branch ">
</div>
...
<input type="text" class="form-control " name="Bank Address" required>
</div>
</div>
<div class="col-md-6">
<div class="form-group form-group-default ">
<label>Bank Landmark </label>
<input type="text" class="form-control " name="Bank Landmark">
</div>
</div>
...
<input type="text" class="form-control " name="Bank City">
</div>
</div>
...
<input type="text" class="form-control " name="Bank Pincode">
</div>
</div>
...
<input type="text" class="form-control " name="Bank Country">
</div>
</div>
...
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2" name="Account Type">
<option value="AK">Select</option>
<option value="AK">Saving</option>
<option value="AK">Current</option>
<option value="AK">Overdraft</option>
<option value="AK">Loan</option>
...
<input type="text" class="form-control " name="Bank Phone No.">
</div>
</div>
...
<input type="text" class="form-control " name="Relationship Manager">
</div>
</div>
...
<input id="Date of Incorp" type="text" class="form-control date" name="Balance Ref Date " >
</div>
</div>
...
<div class="optionBox" id="bank_signatory_box">
    ...
    <div class="block" id="bank_signatory_block">
        <span class="add" id="add_bank_signatory">+ Add Authorised Signatory</span>
    </div>
</div>
</div>
