...
<li class="breadcrumb-item"><a href="#">Manage TDS</a></li>
...
<a href="#"><i style="font-size:22px;" class="fa fa-th-list"></i><br>
Receive</a>
</div>

<div class="col-md-6 rent" style="border-right:none;">
<a href="#"><i style="font-size:22px;" class="fa fa-money"></i><br>
Pay</a>
</div>
...
<thead>
<tr class="p-receipts">
<td  colspan="11">Pending Receipts for TDS</td>
