...
<li class="breadcrumb-item "><a href="sale_list.php">SALES LIST</a></li>
<li class="breadcrumb-item active"><a href="#"> SALES VIEW</a></li>
...
<input type="text" class="form-control "  value="test" name="" id="" readonly>
</div>
</div>
<div class="col-md-6">
<div class="form-group form-group-default ">
...
<input type="text" class="form-control "  value="12/02/2018" name="" id="" readonly>
</div>
</div>
...
<input type="text" class="form-control "  value="1,14,00,000" name="" id="" readonly>
</div>
</div>
<div class="col-md-6">
<div class="form-group form-group-default ">
<label>Cost of Acquisition (In ₹)</label>
<input type="text" class="form-control "  value="0" name="" id="" readonly>
</div>
</div>
...
<input type="text" class="form-control "  value="11,40,00,000" name="" id="" readonly>
</div>
</div>
...
<div class="col-md-4"><div class="form-group form-group-default ">
