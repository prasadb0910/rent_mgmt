...
<input id="applicant_name" type="text" class="form-control" name="applicant_name " >
</div>
</div>
...
<div class="optionBox" id="owner_name_box">
  
    <div class="block" id="owner_name_block">
        <span class="add" id="add_owner_name">+ Add Applicant Details</span>
    </div>
</div>
</div>
...
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2" name="loan_type">
...
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2" name="due_day">
<?php 
...
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2" name="interest_type">
...
<input type="text" class="form-control " name="Repayment" id="Repayment " >
</div>
</div>
...
<div class="optionBox" id="security_box">
  
    <div class="block" id="security_block">
        <span class="add" id="add_security">+ Add Security Details</span>
    </div>
</div>
</div>
...
<div class="optionBox" id="optionBox1">
    ...
    <div class="block" id="block2">
        <span class="add" id="add1">+ Add Document Details.</span>
    </div>
</div>
</div>
