...
#loan_details .form-group-default
{
...
<li class="breadcrumb-item "><a href="loan_list.php">Loan List</a></li>
...
<div class="col-md-4">
<div class="form-group form-group-default form-group-default-select2 required" style="border:1px solid rgba(0,0,0,0.07)!important;">
<label class="">Loan Ref Id </label>
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2" name="ref_id">
<option value="aa">seletct</option>
...
<input id="start_date" type="text" class="form-control  "  value="12/02/2012"  readonly>
</div>
</div>
...
<input type="text" class="form-control" value="31"  readonly >
</div>
</div>
...
<input type="text" class="form-control " value="fixed"  readonly >
</div>
</div>
...
<input id="disbursement_date" type="text" class="form-control date" name="disbursement_date " >
</div>
</div>
...
<input type="text" class="form-control " name="Issuer Bank A/C " id="Issuer Bank A/C  " >
</div>
</div>
...
<input type="text" class="form-control " name="Receiver Bank A/C" id="Receiver Bank A/C" >
</div>
</div>
...
<select class="full-width" data-placeholder="Select Country" data-init-plugin="select2" name="Payment Mode">
...
<br>
  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Schedule</button>
...
<input id="dob" type="text" class="form-control date" name="Date Of Purchase" >
</div></td>
<td><div class="form-group form-group-default "><input type="text" class="form-control " name=""></div></td>
