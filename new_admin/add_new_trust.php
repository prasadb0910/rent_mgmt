...
<li class="breadcrumb-item active">Owner Details - TRUST</li>
</ol>
<div class="row">
<div class="col-md-4">
...
</div><span><a id="clear"><i class=" fa fa-trash pull-right" style="color:#d63b3b;font-size:18px;"></i></a></span></div>
...
<div class="optionBox" id="trustee_box">
  
    <div class="block" id="trustee_block">
        <span class="add" id="add_trustee">+ Add Trustee Details.</span>
    </div>
</div>
</div>
...
<div class="optionBox" id="beneficiary_box">
  
    <div class="block" id="beneficiary_block">
        <span class="add" id="add_beneficiary">+ Add Beneficiary Details.</span>
    </div>
</div>
</div>
