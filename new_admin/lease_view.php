...
.rent-block {
    ...
    -ms-flex: 1 1 auto;
    flex: 1 1 auto;
	/*background-image: linear-gradient(135deg, #5f77df 0%, #7489e3 100%);*/
}
.rent-block .total {
...
<div class="row">
<div class=" col-md-12 rent_list" >


<div class="info pull-left p-l-10" style="margin-top: 25px;text-align:left;">
<span class="">active</span><br>
<span class=""><b> No 1 </b></span><br>
<span class="">1 BHK Flat / 1</span>

</div>

<div style="padding-left: 200px;margin-top: 25px;">
<div class="pull-left"  style=""><i style="font-size:22px;color: #06066f75;" class="fa fa-calendar"></i><br>
Expires<br>
month-to-month
</div>
<div class="pull-left"  style="padding-left: 50px;"><i style="font-size:22px;color: #0080007d;" class="fa fa-home"></i><br>
Rent<br>
Rs. 12,000

</div>
<div class="pull-left"  style="padding-left: 50px;">
<i style="font-size:22px;color: #ff000070;" class="fa fa-money "></i><br>
Balance<br>
Rs. 0
</div>
</div>
