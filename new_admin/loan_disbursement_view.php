...
<li class="breadcrumb-item "><a href="loan_disbursement_list.php">Loan Disbursement  LIST</a></li>
<li class="breadcrumb-item active"><a href="#"> Loan Disbursement  VIEW</a></li>
...
<a href="loan_list.php"><div class="fileUpload blue-btn btn width100 pull-left">
...
<p class="m-t-20"><b>Loan Disbursement Details</b></p>
<div class="a">
<div class="row clearfix">
<div class="col-md-4">
<div class="form-group form-group-default ">
...
<input type="text" class="form-control "value="HDFC Bank - 1234567890"  readonly >
</div>
</div>
